                                ...
                                <asp:GridView ID="GVLeaflitter" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVLeaflitter_RowEditing" OnRowUpdating="GVLeaflitter_RowUpdating" OnRowCancelingEdit="GVLeaflitter_RowCancelingEdit" OnPageIndexChanging="GVLeaflitter_PageIndexChanging" OnRowDataBound="GVLeaflitter_RowDataBound" ShowHeaderWhenEmpty="true" Style="width: 100%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Leaf litter weight (in Grams)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtleaf_litter_weight_in_grams" runat="server" Text='<%# Eval("leaf_litter_weight_in_grams") %>' Width="140" oninput="DecimalCheck(this);" onkeydown="return Search_Gridview(event)"></asp:TextBox>
