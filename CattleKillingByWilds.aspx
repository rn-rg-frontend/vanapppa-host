<%@ Page Title="Van - Details of cattle killing by wild carnivores, village wise cases per year and ex-gratia payment for the period of last five years" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="CattleKillingByWilds.aspx.cs" Inherits="vansystem.CattleKillingByWilds" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Details of cattle killing by wild carnivores, village wise cases per year and ex-gratia payment for the period of last five years</title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="CattleKillingByWild.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add Cattle Killing By Wild</a>
                    </div>
                    ...
                    <asp:BoundField DataField="type_of_cattle" HeaderText="Type of cattle" ReadOnly="True" />
        <asp:BoundField DataField="name" HeaderText="Name" ReadOnly="True" />
        <asp:BoundField DataField="address" HeaderText="Address" ReadOnly="True" />
        <asp:BoundField DataField="attacked_by" HeaderText="Attacked By" ReadOnly="True" />
        <asp:BoundField DataField="others_specify" HeaderText="Others Specify" ReadOnly="True" />
        <asp:BoundField DataField="exgratia_paid" HeaderText="Exgratia Paid (Rs.)" ReadOnly="True" />
