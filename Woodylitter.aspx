                                ...
                                <asp:GridView ID="GVWoodylitter" runat="server" AutoGenerateColumns="false" OnRowEditing="GVWoodylitter_RowEditing" OnRowDataBound="GVWoodylitter_RowDataBound" OnRowUpdating="GVWoodylitter_RowUpdating" OnPageIndexChanging="GVWoodylitter_PageIndexChanging" ShowHeaderWhenEmpty="true" OnRowCancelingEdit="GVWoodylitter_RowCancelingEdit" Style="width: 100%" DataKeyNames="id" AllowPaging="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Woody litter weight (in Grams)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txWoodyLitterWeight" runat="server" Text='<%# Bind("woody_litter_weight_in_grams") %>' oninput="DecimalCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sample weight">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txSampleWeight" runat="server" Text='<%# Bind("sub_sample_weight") %>' onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sample Number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txSampleNumber" runat="server" Text='<%# Bind("sample_number") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
