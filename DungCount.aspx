<%@ Page Title="Van - Dung Count" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="DungCount.aspx.cs" Inherits="vansystem.DungCount" %>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Dung Count</h3>
                            ...
                            <div class="card-body">
                                <table id="users">
                                    <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                        rules="rows" CellPadding="4" CellSpacing="4" Width="100%" DataKeyNames="dung_count_id" OnRowCommand="GVget_RowCommand"  OnPageIndexChanging="GVgetuser_PageIndexChanging" AllowPaging="true" PageSize="10">
        ...
        <asp:BoundField DataField="dung_count_id" HeaderText="Dung Count ID" ReadOnly="True" />
        ...
        <asp:BoundField DataField="transect_no" HeaderText="Transect No" ReadOnly="True" />
        ...
        <asp:BoundField DataField="survey_elatitude" HeaderText="Survey Latitude" ReadOnly="True" />
        <asp:BoundField DataField="survey_elongitude" HeaderText="Survey Longitude" ReadOnly="True" />
        <asp:BoundField DataField="survey_ealtitude" HeaderText="Survey Altitude" ReadOnly="True" />
        <asp:BoundField DataField="survey_eaccuracy" HeaderText="Survey Accuracy" ReadOnly="True" />
        <asp:BoundField DataField="detail_id" HeaderText="Detail ID" ReadOnly="True" />
        <asp:BoundField DataField="nodungs" HeaderText="No. of Dungs" ReadOnly="True" />
        <asp:BoundField DataField="condition" HeaderText="Condition" ReadOnly="True" />
        <asp:BoundField DataField="distancetransect" HeaderText="Distance to Transect" ReadOnly="True" />
