<%@ Page Title="Van - Humidity" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="Humidities.aspx.cs" Inherits="vansystem.Humidities" %>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="Humidity.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add Humidity Data</a>
                    </div>
