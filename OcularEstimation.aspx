<%@ Page Title="Van - Ocular Estimation" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="OcularEstimation.aspx.cs" Inherits="vansystem.OcularEstimation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Ocular Estimation</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Ocular Estimation</h3>
                            ...
                            <div class="card-body">
                                <table id="users">
                                    <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                        rules="rows" CellPadding="4" CellSpacing="4" Width="100%" DataKeyNames="basic_id" OnRowCommand="GVget_RowCommand"  OnPageIndexChanging="GVgetuser_PageIndexChanging" AllowPaging="true" PageSize="10">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="basic_id" HeaderText="Basic ID" ReadOnly="True" />
        ...
        <asp:BoundField DataField="saltitude" HeaderText="S Altitude" ReadOnly="True" />
        <asp:BoundField DataField="saccuracy" HeaderText="S Accuracy" ReadOnly="True" />
        <asp:BoundField DataField="stime" HeaderText="S Time" ReadOnly="True" />
        ...
        <asp:BoundField DataField="burn_status" HeaderText="Burn Status" ReadOnly="True" />
        <asp:BoundField DataField="terrain" HeaderText="Terrain" ReadOnly="True" />
        <asp:BoundField DataField="distnce_observer" HeaderText="Distance Observer" ReadOnly="True" />
        <asp:BoundField DataField="activity" HeaderText="Activity" ReadOnly="True" />
        <asp:BoundField DataField="direction" HeaderText="Direction" ReadOnly="True" />
        <asp:BoundField DataField="remarks" HeaderText="Remarks" ReadOnly="True" />
        <asp:BoundField DataField="etime" HeaderText="E Time" ReadOnly="True" />
        <asp:BoundField DataField="elatitude" HeaderText="E Latitude" ReadOnly="True" />
        <asp:BoundField DataField="elongitude" HeaderText="E Longitude" ReadOnly="True" />
        <asp:BoundField DataField="ealtitude" HeaderText="E Altitude" ReadOnly="True" />
        <asp:BoundField DataField="eaccuracy" HeaderText="E Accuracy" ReadOnly="True" />
