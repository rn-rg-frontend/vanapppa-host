<%@ Page Title="Van - Mammal Vehicle Count" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="MammalVehicleCount.aspx.cs" Inherits="vansystem.MammalVehicleCount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Mammal Vehicle Count</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Mammal Vehicle Count</h3>
                            ...
                            <div class="card-body">
                                <table id="users">
                                    <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                        rules="rows" CellPadding="4" CellSpacing="4" Width="100%" DataKeyNames="mammal_vehicle_count_id" OnRowCommand="GVget_RowCommand"  OnPageIndexChanging="GVgetuser_PageIndexChanging" AllowPaging="true" PageSize="10">
        ...
        <asp:BoundField DataField="survey_date" HeaderText="Survey Date" ReadOnly="True" />
        <asp:BoundField DataField="animal_detail_id" HeaderText="Animal Detail ID" ReadOnly="True" />
        <asp:BoundField DataField="animal" HeaderText="Animal" ReadOnly="True" />
        <asp:BoundField DataField="distance_transent" HeaderText="Distance Transent" ReadOnly="True" />
