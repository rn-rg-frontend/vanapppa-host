<%@ Page Title="Van - Birds Pop WaterBird" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="BirdsPopWaterBird.aspx.cs" Inherits="vansystem.BirdsPopWaterBird" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Birds Pop WaterBird</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Birds Pop WaterBird</h3>
                            ...
                            <div class="card-body">
                                <table id="users">
                                    <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                        rules="rows" CellPadding="4" CellSpacing="4" Width="100%" DataKeyNames="birds_pop_water_bird_id" OnRowCommand="GVget_RowCommand"  OnPageIndexChanging="GVgetuser_PageIndexChanging" AllowPaging="true" PageSize="10">
        ...
        <asp:BoundField DataField="waterlevel" HeaderText="Water Level" ReadOnly="True" />
        <asp:BoundField DataField="vegcover" HeaderText="Vegetation Cover" ReadOnly="True" />
        <asp:BoundField DataField="humanimpact" HeaderText="Human Impact" ReadOnly="True" />
        ...
        <asp:BoundField DataField="adult" HeaderText="Adult" ReadOnly="True" />
        <asp:BoundField DataField="subadult" HeaderText="Subadult" ReadOnly="True" />
