<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="StaticNonClump.aspx.cs" Inherits="vansystem.StaticNonClump" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3><b>Plot Enumeration-NonClump(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="Stump" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Stump_Command" Text="Stump"> </asp:LinkButton>
                         <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="NonClump" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="NonClump_Command" Text="Non Clump"> </asp:LinkButton>
                ...
                <div class="card-body" style="height: 100vh!important; overflow-y: auto; margin-left: 2%; width: 99%;">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content" style="margin-top:1%">
                                <asp:GridView ID="GVClump" runat="server" AutoGenerateColumns="false" OnRowEditing="GVClump_RowEditing" OnRowUpdating="GVClump_RowUpdating" OnPageIndexChanging="GVClump_PageIndexChanging" OnRowCancelingEdit="GVClump_RowCancelingEdit" OnRowDataBound="GVClump_RowDataBound" ShowHeaderWhenEmpty="true" Style="width: 100%" DataKeyNames="id" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Clump Number">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClumpNo" runat="server" Text='<%# Eval("nonClumpNumber")%>'></asp:Label>
                                            </ItemTemplate>
                                           <EditItemTemplate>
                                                <asp:TextBox ID="txtClumpNo" runat="server" Text='<%# Eval("nonClumpNumber") %>' Width="140"  onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Clump Data Direction" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClumpDataDir" runat="server" Text='<%# Eval("nonClumpDataDirection") %>'></asp:Label>
                                            </ItemTemplate>
                                            <%--<EditItemTemplate>
                                                <asp:TextBox ID="txtClumpDataDir" runat="server" Text='<%# Eval("nonClumpDataDirection") %>' Width="140"  onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>--%>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Clumping Bamboo Data" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblClumpingData" runat="server" Text='<%# Eval("Local_Name") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Other" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOther" runat="server" Text='<%# Eval("other") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtOther" runat="server" Text='<%# Eval("other") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <%--<asp:BoundField ItemStyle-Width="150px" DataField="stumpHeight" HeaderText="Stump Height">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>--%>
                                        <asp:TemplateField HeaderText="No of Bamboo Culms" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNoOfBambooCulms" runat="server" Text='<%# Eval("noOfBambooCulms") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtNoOfBambooCulms" runat="server" Text='<%# Eval("noOfBambooCulms") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Grith (in cm)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblGrith" runat="server" Text='<%# Eval("girth") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtGrith" runat="server" Text='<%# Eval("girth") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Height (in meter)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblHeight" runat="server" Text='<%# Eval("height") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtHeight" runat="server" Text='<%# Eval("height") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
