                                ...
                                <asp:GridView ID="GVLeaflitter" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVLeaflitter_RowEditing" OnRowUpdating="GVLeaflitter_RowUpdating" OnPageIndexChanging="GVLeaflitter_PageIndexChanging" ShowHeaderWhenEmpty="true" OnRowDataBound="GVLeaflitter_RowDataBound" OnRowCancelingEdit="GVLeaflitter_RowCancelingEdit" Style="width: 100%" AllowPaging="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Leaf litter weight (in Grams)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txLeafLitterWeight" runat="server" Text='<%# Bind("leaf_litter_weight_in_grams") %>' oninput="DecimalCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sample weight">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txSampleWeight" runat="server" Text='<%# Bind("sub_sample_weight") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sample Number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txSampleNumber" runat="server" Text='<%# Bind("sample_number") %>' onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
