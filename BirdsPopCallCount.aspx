<%@ Page Title="Van - Birds Pop Call Count" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="BirdsPopCallCount.aspx.cs" Inherits="vansystem.BirdsPopCallCount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Birds Pop Call Count</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Birds Pop Call Count</h3>
                            ...
                            <div class="card-body">
                                <table id="users">
                                    <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                        rules="rows" CellPadding="4" CellSpacing="4" Width="100%" DataKeyNames="call_count_id" OnRowCommand="GVget_RowCommand"  OnPageIndexChanging="GVgetuser_PageIndexChanging" AllowPaging="true" PageSize="10">
        ...
        <asp:BoundField DataField="callcount" HeaderText="Call Count" ReadOnly="True" />
