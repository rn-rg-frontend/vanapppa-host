<%@ Page Title="Van - Mortality attributed to poaching" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="MortalityAttributedToPoachings.aspx.cs" Inherits="vansystem.MortalityAttributedToPoachings" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Mortality attributed to poaching</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="app-content">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="MortalityAttributedToPoaching.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add Mortality attributed to poaching</a>
                    </div>
        ...
        <asp:BoundField DataField="condition_during_discovery" HeaderText="Condition During Discovery" ReadOnly="True" />
        <asp:BoundField DataField="cause_of_mortality" HeaderText="Cause of Mortality" ReadOnly="True" />
        <asp:BoundField DataField="cause_known" HeaderText="Cause Known" ReadOnly="True" />
        <asp:BoundField DataField="cause_others" HeaderText="Cause Others" ReadOnly="True" />
