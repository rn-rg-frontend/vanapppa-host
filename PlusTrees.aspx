<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="PlusTrees.aspx.cs" Inherits="vansystem.PlusTrees" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="box-content" onkeydown="return Search_Gridview(event)">
                                ...
                                <asp:GridView ID="gvRare" runat="server" AutoGenerateColumns="false" DataKeyNames="id,Locationid" OnRowEditing="gvRare_RowEditing" OnRowUpdating="gvRare_RowUpdating" OnRowCancelingEdit="gvRare_RowCancelingEdit" OnPageIndexChanging="gvRare_PageIndexChanging" GridLines="Horizontal" AllowPaging="true" PageSize="10" ShowHeaderWhenEmpty="true" OnRowCommand="gvRare_RowCommand" OnRowDataBound="gvRare_RowDataBound">
