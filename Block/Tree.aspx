<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="Tree.aspx.cs" Inherits="vansystem.Block.Tree" %>
    ...
    <div <%--class="card" style="height: 826px; background-color: #EFEFEF"--%>>
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                <h3><b>Plot Enumeration-Tree(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                ...
                <div class="card-body" style="background-color: rgb(252, 252, 252); margin-left: 60px;">
                    ...
                    <div class="box-content">
                        <asp:GridView ID="GVTree" runat="server" HeaderStyle-Width="10%" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id"  Style="width: auto" OnPageIndexChanging="GVTree_PageIndexChanging" PageSize="10" AllowPaging="true">
