<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="Leaflitter.aspx.cs" Inherits="vansystem.Block.Leaflitter" %>
            ...
            <div <%--class="card" style="height: 826px; background-color: #EFEFEF"--%>>
                <div class="container-fluid mt-6">
                    <div style="margin-left: 0%;/* width: 113%;*/ margin-top: 88px;">
                        <h3><b>Plot Enumeration-LitterLeaf(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252);  margin-left:60px; ">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVLeaflitter" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnPageIndexChanging="GVLeaflitter_PageIndexChanging" ShowHeaderWhenEmpty="true" Style="width: 100%" AllowPaging="true" PageSize="10">
