<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="DeadWood.aspx.cs" Inherits="vansystem.Block.DeadWood" %>
                    ...
                    <div style="margin-left: 0%; /*width: 113%;*/ margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); margin-left:60px;  ">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVDeadWood" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnPageIndexChanging="GVDeadWood_PageIndexChanging"  ShowHeaderWhenEmpty="true" Style="width: 100%" AllowPaging="true" PageSize="10">
