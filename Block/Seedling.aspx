<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="Seedling.aspx.cs" Inherits="vansystem.Block.Seedling" %>
            ...
            <div <%--class="card" style="height: 826px; background-color: #EFEFEF"--%>>
                <div class="container-fluid mt-6">
                    <div style="margin-left: 0%;/* width: 113%;*/ margin-top: 88px;">
                        <h3><b>Plot Enumeration-Seedling(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
