<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="NTFPExtraction.aspx.cs" Inherits="vansystem.Block.NTFPExtraction" %>
            ...
            <div>
                <div class="container-fluid mt-6">
                    <div style="margin-left: 0%;  margin-top: 88px;">
                        <h3><b>NTFP Extraction Records</b></h3>
                        <div class="card-body" style="background-color: rgb(252, 252, 252); margin-left:-2000px;">
                            ...
                            <asp:DropDownList ID="ddlPageSize" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPageSize_SelectedIndexChanged">
                                ...
                                <asp:GridView runat="server" AlternatingRowStyle-CssClass="infoarea" ID="gvActivity" AutoGenerateColumns="false" DataKeyNames="NTFPExtractionId" AllowPaging="true" OnPageIndexChanging="gvActivity_PageIndexChanging" PageSize="10" ShowHeaderWhenEmpty="true">
