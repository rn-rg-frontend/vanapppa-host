<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="Climber.aspx.cs" Inherits="vansystem.Block.Climber" %>
                    ...
                    <div style="margin-left: 0%;/* width: 113%;*/ margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); margin-left:60px; ">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVClimber" runat="server" DataKeyNames="id" ShowHeaderWhenEmpty="true"  OnPageIndexChanging="GVClimber_PageIndexChanging" AutoGenerateColumns="false" Style="width: 100%" AllowPaging="true" PageSize="10">
