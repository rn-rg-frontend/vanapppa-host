<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="Climberfull.aspx.cs" Inherits="vansystem.Block.Climberfull" %>
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252); margin-left:60px; ">
                            <div style="margin-left: 90%;">
                             ...
                             <div class="box-content">
                                ...
                                <asp:GridView ID="GVClimber" runat="server" DataKeyNames="id" ShowHeaderWhenEmpty="true"  AutoGenerateColumns="false" Style="width: 100%" AllowPaging="true" PageSize="10" OnPageIndexChanging="GVClimber_PageIndexChanging">
