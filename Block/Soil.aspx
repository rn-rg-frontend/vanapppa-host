<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="Soil.aspx.cs" Inherits="vansystem.Block.Soil" %>
                    ...
                    <div style="margin-left: 0%;/* width: 113%;*/ margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252);  margin-left:60px; ">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVSoil" runat="server" AutoGenerateColumns="false" DataKeyNames="id" Style="width: 100%"  OnPageIndexChanging="GVSoil_PageIndexChanging" ShowHeaderWhenEmpty="true" AllowPaging="true" PageSize="10">
