<%@ Page Title="" Language="C#" MasterPageFile="~/Block/Block.Master" AutoEventWireup="true" CodeBehind="Shrubfull.aspx.cs" Inherits="vansystem.Block.Shrubfull" %>
                    ...
                    <div style="margin-left: 0%; /*width: 113%;*/ margin-top: 88px;">
                        ...
                        <div class="card-body" style="background-color: rgb(252, 252, 252);  margin-left:60px;">
                            ...
                            <div class="box-content">
                                <asp:GridView ID="GVShurb" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"  DataKeyNames="id" Style="width: auto" AllowPaging="true" PageSize="10" OnPageIndexChanging="GVShurb_PageIndexChanging">
