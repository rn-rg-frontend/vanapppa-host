<%@ Page Title="Van - Mammal Sign Survey" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="MammalPopSignSurvey.aspx.cs" Inherits="vansystem.MammalPopSignSurvey" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Mammal Sign Survey</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Mammal Sign Survey</h3>
        ...
        <asp:BoundField DataField="trailno" HeaderText="Trail No" ReadOnly="True" />
        ...
        <asp:BoundField DataField="signtype" HeaderText="Sign Type" ReadOnly="True" />
        <asp:BoundField DataField="scat" HeaderText="Scat" ReadOnly="True" />
        <asp:BoundField DataField="reliability" HeaderText="Reliability" ReadOnly="True" />
        <asp:BoundField DataField="survey_etime" HeaderText="Survey End Time" ReadOnly="True" />
        <asp:BoundField DataField="survey_elatitude" HeaderText="Survey End Latitude" ReadOnly="True" />
        <asp:BoundField DataField="survey_elongitude" HeaderText="Survey End Longitude" ReadOnly="True" />
        <asp:BoundField DataField="survey_ealtitude" HeaderText="Survey End Altitude" ReadOnly="True" />
        <asp:BoundField DataField="survey_eaccuracy" HeaderText="Survey End Accuracy" ReadOnly="True" />
        <asp:BoundField DataField="animal" HeaderText="Animal" ReadOnly="True" />
        <asp:BoundField DataField="detail_signtype" HeaderText="Detail Sign Type" ReadOnly="True" />
        <asp:BoundField DataField="detail_scat" HeaderText="Detail Scat" ReadOnly="True" />
        <asp:BoundField DataField="detail_reliability" HeaderText="Detail Reliability" ReadOnly="True" />
        <asp:BoundField DataField="detail_etime" HeaderText="Detail End Time" ReadOnly="True" />
        <asp:BoundField DataField="detail_elatitude" HeaderText="Detail End Latitude" ReadOnly="True" />
        <asp:BoundField DataField="detail_elongitude" HeaderText="Detail End Longitude" ReadOnly="True" />
        <asp:BoundField DataField="detail_ealtitude" HeaderText="Detail End Altitude" ReadOnly="True" />
        <asp:BoundField DataField="detail_eaccuracy" HeaderText="Detail End Accuracy" ReadOnly="True" />
