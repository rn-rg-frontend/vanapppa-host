<%@ Page Title="Van - Major biodiversity conservation initiatives and milestones" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="MajorBiodiversities.aspx.cs" Inherits="vansystem.MajorBiodiversities" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Major biodiversity conservation initiatives and milestones</title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="MajorBiodiversity.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add Biodiversity Detail</a>
                    </div>
                    <div class="pull-right">
                                ...
                                <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Name of the scheme">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNameOfScheme" Text='<%# Eval("name_of_scheme") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtNameOfScheme" Width="150px"  CssClass="form-control" Text='<%# Bind("name_of_scheme") %>' MaxLength="25" onkeypress="return isAlphabet(event)" runat="server" />
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNameOfScheme" ErrorMessage="Please fill out this field." ForeColor="Red">
                                                </asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Sponsored by">
                                            <ItemTemplate>
                                                <asp:Label ID="lblFinance" Text='<%# Eval("finance") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Year Of implementation">
                                            <ItemTemplate>
                                                <asp:Label ID="lblYearOfImplementation" Text='<%# Eval("year_of_implimentation") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Major Initiative">
                                            <ItemTemplate>
                                                <asp:Label ID="lblMajorInitiative" Text='<%# Eval("major_initiative") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Other">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOtherInitiative" Text='<%# Eval("other_initiative") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtOtherInitiative"  CssClass="form-control" Text='<%# Bind("other_initiative") %>' runat="server" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtOtherInitiative" ErrorMessage="Please fill out this field." CssClass="required-field-message" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Finance Data (in lakhs)">
                                            <ItemTemplate>
                                                <asp:Label ID="lblFinanceData" Text='<%# Eval("finance_data") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtFinanceData"  CssClass="form-control" Text='<%# Bind("finance_data") %>' runat="server" oninput="DecimalCheck(this)" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtFinanceData" ErrorMessage="Please fill out this field." CssClass="required-field-message" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Summary of the program">
                                            <ItemTemplate>
                                                <asp:Label ID="lblSummaryOfTheProgram" Text='<%# Eval("summary_of_the_program") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtSummaryOfTheProgram"  CssClass="form-control" Text='<%# Bind("summary_of_the_program") %>' runat="server" TextMode="MultiLine" Rows="3" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtSummaryOfTheProgram" ErrorMessage="Please fill out this field." CssClass="required-field-message" Display="Dynamic"></asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
