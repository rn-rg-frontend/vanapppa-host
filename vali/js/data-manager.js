...
$(document).ready(function () {
	...
	var ajaxURL = '';
    if(typeof($('#gvVLI').data('call')) != 'undefined') {
        ajaxURL = $('#gvVLI').data('call');
    } else {
        console.error('ERROR! call URL is not provided.');
    }

	var data = {};
	if(typeof($('#gvVLI').data('form')) != 'undefined') {
        data.form = $('#gvVLI').data('form');
    }

	if(typeof($('#gvVLI').data('group')) != 'undefined') {
        data.group = $('#gvVLI').data('group');
    }

	if(typeof($('#gvVLI').data('survey')) != 'undefined') {
        data.survey = $('#gvVLI').data('survey');
    }
