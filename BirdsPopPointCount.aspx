<%@ Page Title="Van - Birds Pop Point Count" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="BirdsPopPointCount.aspx.cs" Inherits="vansystem.BirdsPopPointCount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Birds Pop Point Count</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Birds Pop Point Count</h3>
                            ...
                            <div class="card-body">
                                <table id="users">
                                    <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                        rules="rows" CellPadding="4" CellSpacing="4" Width="100%" DataKeyNames="birds_pop_point_count_id" OnRowCommand="GVget_RowCommand"  OnPageIndexChanging="GVgetuser_PageIndexChanging" AllowPaging="true" PageSize="10">
        ...
        <asp:BoundField DataField="offsite" HeaderText="Offsite" ReadOnly="True" />
        ...
        <asp:BoundField DataField="east" HeaderText="East" ReadOnly="True" />
        <asp:BoundField DataField="west" HeaderText="West" ReadOnly="True" />
        <asp:BoundField DataField="north" HeaderText="North" ReadOnly="True" />
        <asp:BoundField DataField="south" HeaderText="South" ReadOnly="True" />
        ...
        <asp:BoundField DataField="radialdistance" HeaderText="Radial Distance" ReadOnly="True" />
        <asp:BoundField DataField="additionalinfo" HeaderText="Additional Info" ReadOnly="True" />
        <asp:BoundField DataField="recform" HeaderText="Rec Form" ReadOnly="True" />
        <asp:BoundField DataField="flyoverstatus" HeaderText="Flyover Status" ReadOnly="True" />
        <asp:BoundField DataField="vegcover" HeaderText="Veg Cover" ReadOnly="True" />
        ...
        <asp:BoundField DataField="lopplogg" HeaderText="Lopplogg" ReadOnly="True" />
