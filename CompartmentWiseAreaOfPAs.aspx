<%@ Page Title="Van -  COMPARTMENT-WISE AREA OF THE PA" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="CompartmentWiseAreaOfPAs.aspx.cs" Inherits="vansystem.CompartmentWiseAreaOfPAs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van -  COMPARTMENT-WISE AREA OF THE PA</title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="CompartmentWiseAreaOfPA.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add  COMPARTMENT-WISE AREA OF THE PA	</a>
                    </div>
                    <div class="pull-right">
                                ...
                                <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Range">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtRange" Text='<%# Eval("range") %>' runat="server" CssClass="form-control" required="true"></asp:TextBox>
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="rfvRange" runat="server" ControlToValidate="txtRange" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <asp:TemplateField HeaderText="Beat">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBeat" Text='<%# Eval("beat") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtBeat" Text='<%# Eval("beat") %>' runat="server" CssClass="form-control" required="true"></asp:TextBox>
                                                <asp:RequiredFieldValidator  Display="Dynamic"  ID="rfvBeat" runat="server" ControlToValidate="txtBeat" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>

                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Compt. No.">
                                            <ItemTemplate>
                                                <asp:Label ID="lblComptNo" Text='<%# Eval("compt_no") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtComptNo" runat="server" CssClass="form-control" Text='<%# Eval("compt_no") %>' required="true"></asp:TextBox>
                                                <asp:RequiredFieldValidator  Display="Dynamic"  ID="rfvComptNo" runat="server" ControlToValidate="txtComptNo" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>

                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Area in Ha.">
                                            <ItemTemplate>
                                                <asp:Label ID="lblAreaInHa" Text='<%# Eval("area_in_ha") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtAreaInHa" runat="server" CssClass="form-control" Text='<%# Eval("area_in_ha") %>' oninput="DecimalCheck(this)" required="true"></asp:TextBox>
                                                <asp:RequiredFieldValidator  Display="Dynamic"  ID="rfvAreaInHa" runat="server" ControlToValidate="txtAreaInHa" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
                                        ...
                                        <asp:TemplateField HeaderText="Zone">
                                            <ItemTemplate>
                                                <asp:Label ID="lblZone" Text='<%# Eval("zone") %>' runat="server" />
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtZone" runat="server" CssClass="form-control" Text='<%# Eval("zone") %>' required="true"></asp:TextBox>
                                                <asp:RequiredFieldValidator  Display="Dynamic"  ID="rfvZone" runat="server" ControlToValidate="txtZone" ErrorMessage="Required" ForeColor="Red"></asp:RequiredFieldValidator>
