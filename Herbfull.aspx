...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <a href="IVICal.aspx">IVICal.aspx</a>
    <style>
                                ...
                                <asp:GridView ID="GVHerb" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id,PlotEnumerationId" OnRowEditing="GVHerb_RowEditing" OnRowUpdating="GVHerb_RowUpdating" OnPageIndexChanging="GVHerb_PageIndexChanging" OnRowCancelingEdit="GVHerb_RowCancelingEdit" OnRowDataBound="GVHerb_RowDataBound" Style="width: 100%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Average number" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtaverageherbs" runat="server" Text='<%# Eval("averageherbs") %>' Width="140" oninput="DecimalCheck(this);" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in cm)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtheight" runat="server" Text='<%# Eval("height") %>' Width="140" oninput="DecimalCheck(this);" onkeyup="delayedValidation2(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="NTFP utility- Part of the tree">
                                         ...
                                         <asp:TemplateField HeaderText="Approx. weight of NTFP in grams">
                                          <%--  <EditItemTemplate>
                                                <asp:TextBox ID="txtApproxNTFP" runat="server" Text='<%# Bind("approx") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>--%>
                                            <ItemTemplate>
