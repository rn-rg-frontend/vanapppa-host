                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                ...
                                <asp:GridView ID="GVClimber" runat="server" DataKeyNames="id" ShowHeaderWhenEmpty="true" OnRowEditing="GVClimber_RowEditing" OnRowDataBound="GVClimber_RowDataBound" OnRowUpdating="GVClimber_RowUpdating" AutoGenerateColumns="false" Style="width: 100%" OnPageIndexChanging="GVClimber_PageIndexChanging" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Average number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txAverageNumber" runat="server" Text='<%# Bind("climbernumber") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
