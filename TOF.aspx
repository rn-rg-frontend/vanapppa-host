<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="TOF.aspx.cs" Inherits="vansystem.TOF" EnableEventValidation="false" %>
                ...
                <div class="card-body" id="cardBody" style="height: 100vh!important; overflow-y: auto; margin-left: 3.5rem !important; width: 98%;">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <div class="box-content" onkeydown="return Search_Gridview(event)" <%--style="display: flex; align-items: center;margin-top: -11.1px"--%>>
                                ...
                                <asp:GridView ID="gvtof" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="gvtof_RowEditing" OnRowUpdating="gvtof_RowUpdating" OnRowCancelingEdit="gvtof_RowCancelingEdit" OnPageIndexChanging="gvtof_PageIndexChanging" GridLines="Horizontal" AllowPaging="true" PageSize="10" ShowHeaderWhenEmpty="true" OnRowCommand="gvtof_RowCommand" OnRowDataBound="gvtof_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Diameter(DBH in cm)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="200%">
                                            <HeaderStyle CssClass="sortable-header" />
                                            <ItemTemplate>
                                        ...
                                        <%--<asp:TemplateField HeaderText="DFO Approval" ShowHeader="false">
                                            <ItemTemplate>
                                                <asp:Button ID="Button2" runat="server" CssClass="btn-approved btn-primary" class="btn-approved" CausesValidation="false" CommandName="cmdApprove" CommandArgument="<%#((GridViewRow)Container).RowIndex %>" Text="Approve"/>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
