<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="AnnualFodderConsumption.aspx.cs" Inherits="vansystem.AnnualFodderConsumption" %>
    ...
    <script type="text/javascript">
        function Search_function(strKey) {
            ...
            if (!messageElement) {
                ...
                messageElement.style.marginLeft = '-480vw'
            ...
            // Hide page navigation if no record found
            var pagination = document.getElementById('pagingnation');
            ...
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                <div class="d-md-flex justify-content-between text-center align-items-center">
                    <div style="margin-left: 3% !important;">
                        <h3 style="margin-inline: auto; margin-left: 40px !important;"><b>Annual Fodder Consumption</b></h3>

                    </div>
                    <div class="row d-sm-flex justify-content-center align-items-end text-center">

                        <div>
                            <asp:Label ID="recordNotFoundMessage" runat="server" Style="display: none; margin-left: -140px; color: red !important;">No records found.</asp:Label>
                        </div>
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Quantity of Fodder Provided (in Kgs)">
                                            <EditItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtquantity1" runat="server" Text='<%# Bind("Quantity_of_fodder_provided") %>' onkeydown="return Search_Gridview(event)" oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Frequency (Per Month)">
                                            <EditItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtfrequency1" runat="server" Text='<%# Bind("Frequency_per_month") %>' onkeydown="return Search_Gridview(event)" oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Quantity of Fodder Provided (in Kgs)">
                                            <EditItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtquantity2" runat="server" Text='<%# Bind("Quantity_of_fodder_so_obtained") %>' onkeydown="return Search_Gridview(event)" oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Frequency (Per Month)">
                                            <EditItemTemplate>
                                                ...
                                                <asp:TextBox ID="txtfrequency2" runat="server" Text='<%# Bind("Plantation_Frequency_per_month") %>' onkeydown="return Search_Gridview(event)" oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="RFO Approval" ShowHeader="False">
                                            <ItemTemplate>
                                                <asp:Button ID="Button3" runat="server" CausesValidation="false" CommandName="" Text="RFO Not Approved" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
