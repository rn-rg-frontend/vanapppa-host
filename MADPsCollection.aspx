<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="MADPsCollection.aspx.cs" Inherits="vansystem.MADPsCollection" EnableEventValidation="false" %>
                                ...
                                <asp:GridView ID="gvMADP" AutoGenerateColumns="False" runat="server" DataKeyNames="id" OnRowEditing="gvMADP_RowEditing" OnRowUpdating="gvMADP_RowUpdating" OnRowCancelingEdit="gvMADP_RowCancelingEdit" OnPageIndexChanging="gvMADP_PageIndexChanging" AllowPaging="true" PageSize="10" ShowHeaderWhenEmpty="true" OnRowCommand="gvMADP_RowCommand" OnRowDataBound="gvMADP_RowDataBound" OnPreRender="gvMADP_PreRender">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks (if any)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox onkeydown="return Search_Gridview(event)" ID="txtRemarks" runat="server" Text='<%# Bind("madp1_remarks") %>' Enabled='<%# !string.IsNullOrEmpty(Eval("madp1_remarks").ToString()) %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle Width="20%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Mode of Collection">
                                        ...
                                        <asp:TemplateField HeaderText="Remarks (if any)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox onkeydown="return Search_Gridview(event)" ID="txtMadp2Remarks" runat="server" Enabled='<%# !string.IsNullOrEmpty(Eval("madp2_remarks").ToString()) %>' Text='<%# Bind("madp2_remarks") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle Width="20%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Mode of Collection">
                                        ...
                                        <asp:TemplateField HeaderText="Remarks (if any)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox onkeydown="return Search_Gridview(event)" Enabled='<%# !string.IsNullOrEmpty(Eval("madp3_remarks").ToString()) %>' ID="txtMadp3Remarks" runat="server" Text='<%# Bind("madp3_remarks") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle Width="20%" />
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Mode of Collection">
                                        ...
                                        <asp:TemplateField HeaderText="Remarks (if any)">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox onkeydown="return Search_Gridview(event)" Enabled='<%# !string.IsNullOrEmpty(Eval("madp4_remarks").ToString()) %>' ID="txtMadp4Remarks" runat="server" Text='<%# Bind("madp4_remarks") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemStyle Width="20%" />
                                        </asp:TemplateField>
