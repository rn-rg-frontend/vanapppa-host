...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
      ...
      <asp:Label ID="recordNotFoundMessage" runat="server" Style="display: none; margin-left: -140px;">No records found.</asp:Label>
            ...
            <div class="card-body" id="cardBody" style="height: 100vh!important; overflow-y: auto; margin-left: 3.5rem !important; width: 98.6% !important;">
                            ...
                            <asp:GridView ID="gvHousehold" DataKeyNames="id" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="gvHousehold_PageIndexChanging" OnRowEditing="gvHousehold_RowEditing" OnRowUpdating="gvHousehold_RowUpdating" OnPreRender="gvHousehold_PreRender" OnRowCancelingEdit="gvHousehold_RowCancelingEdit" AllowPaging="True" Style="width: 100%" ShowHeaderWhenEmpty="True" OnRowCommand="gvHousehold_RowCommand" OnRowDataBound="gvHousehold_RowDataBound">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="S.No" ItemStyle-Width="200%">
                                        ...
                                        <HeaderStyle CssClass="sticky-header-table" />
                                        <ItemStyle CssClass="sticky-column" />
                                    ...
                                    <asp:TemplateField HeaderText="Size of Land Holding (in ha)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtsize_land" runat="server" Text='<%# Eval("size_land") %>' Width="140" Enabled='<%# !string.IsNullOrEmpty(Eval("size_land").ToString()) %>' onkeydown="return Search_Gridview(event)" oninput="NumberCheck(this)"></asp:TextBox>
                                        </EditItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function calculateTotalFamilyMembers() {            var no_males = parseInt(document.getElementById('txtno_males').value) || 0;            var no_female = parseInt(document.getElementById('txtno_female').value) || 0;            var no_child = parseInt(document.getElementById('txtno_child').value) || 0;            console.log("no_males:", no_males);            console.log("no_female:", no_female);            console.log("no_child:", no_child);            var total_familymembers = no_males + no_female + no_child;            console.log("total_familymembers:", total_familymembers);            // Update the value of the 'txtfamilymembers' TextBox            var txtfamilymembers = document.getElementById('txtfamilymembers');            if (txtfamilymembers) {                txtfamilymembers.value = total_familymembers;                console.log("Updated txtfamilymembers value:", txtfamilymembers.value);            } else {                console.log("Error: 'txtfamilymembers' element not found.");            }        }
