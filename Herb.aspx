                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                ...
                                <asp:GridView ID="GVHerb" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVHerb_RowEditing" OnRowUpdating="GVHerb_RowUpdating" OnPageIndexChanging="GVHerb_PageIndexChanging" OnRowCancelingEdit="GVHerb_RowCancelingEdit" OnRowDataBound="GVHerb_RowDataBound" Style="width: 100%; margin-top: -1.25%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Average number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtAverageNumber" runat="server" Text='<%# Bind("averageherbs") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbAverageNumber" runat="server" Text='<%# Bind("averageherbs") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in cm)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtHeightcm" runat="server" Text='<%# Bind("height") %>' oninput="DecimalCheck(this)" onkeyup="delayedValidation2(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks (if any)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtAremark" runat="server" Text='<%# Bind("remark") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
