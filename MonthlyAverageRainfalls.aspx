<%@ Page Title="Van - Monthly average rainfall data (mm)" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="MonthlyAverageRainfalls.aspx.cs" Inherits="vansystem.MonthlyAverageRainfalls" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Monthly average rainfall data (mm)</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="app-content">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="MonthlyAverageRainfall.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add Monthly average rainfall data</a>
                    </div>
        ...
        <asp:BoundField DataField="january" HeaderText="January" ReadOnly="True" />
        <asp:BoundField DataField="february" HeaderText="February" ReadOnly="True" />
        <asp:BoundField DataField="march" HeaderText="March" ReadOnly="True" />
        ...
        <asp:BoundField DataField="august" HeaderText="August" ReadOnly="True" />
        <asp:BoundField DataField="september" HeaderText="September" ReadOnly="True" />
        <asp:BoundField DataField="october" HeaderText="October" ReadOnly="True" />
