        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <div>
                            <h3><b style="position: sticky">Plot Enumeration-Bamboo(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                        </div>
                    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVBamboo" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVBamboo_RowEditing" OnRowCancelingEdit="GVBamboo_RowCancelingEdit" OnRowUpdating="GVBamboo_RowUpdating" OnRowDataBound="GVBamboo_RowDataBound" OnPageIndexChanging="GVBamboo_PageIndexChanging" AllowPaging="true" Style="width: 100%; margin-top: -1%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Diameter of Bamboo Clump (in m)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtDiameter" runat="server" Text='<%# Bind("bamboodiameter") %>' oninput="NumberCheck(this)" onkeyup="delayedValidation1(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbDiameter" runat="server" Text='<%# Bind("bamboodiameter") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="No. of Bamboo Culms">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtNoOfBambooCulms" runat="server" Text='<%# Bind("bambooculms") %>' oninput="NumberCheck(this)" onkeyup="delayedValidation2(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbNoOfBambooCulms" runat="server" Text='<%# Bind("bambooculms") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="GBH">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtGBH" runat="server" Text='<%# Bind("bamboogbh") %>' onkeydown="return Search_Gridview(event)" onkeyup="delayedValidation2(this)"></asp:TextBox>

                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbGBH" runat="server" Text='<%# Bind("bamboogbh") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in meters)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtHeight" runat="server" Text='<%# Bind("bambooheight") %>' oninput="NumberCheck(this)" onkeyup="delayedValidation1(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbHeight" runat="server" Text='<%# Bind("bambooheight") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks if any">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txRemark" runat="server" Text='<%# Bind("bambooremarks") %>' onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbRemark" runat="server" Text='<%# Bind("bambooremarks") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
