<%@ Page Title="Van - Research - Survey and Inventories" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="SurveyAndInventories.aspx.cs" Inherits="vansystem.SurveyAndInventories" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Research - Survey and Inventories</title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="SurveyAndInventory.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add Survey and Inventory</a>
                    </div>
                    <div class="pull-right">
                                ...
                                <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Name of Agency/Individual">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="name_of_agency_individual" Text='<%# Bind("name_of_agency_individual") %>' runat="server" CssClass="form-control" placeholder="Title of survey/inventory" MaxLength="25" onkeypress="return isAlphabet(event)" />
                                        ...
                                        <asp:TemplateField HeaderText="End Date">
                                            <ItemTemplate>
                                                <%# Convert.ToDateTime(Eval("end_date")).ToString("MM/dd/yyyy") %>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox name="end_date" ID="end_date" runat="server"
                                                    TextMode="Date">
                                                </asp:TextBox>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Display="Dynamic" ControlToValidate="end_date" ErrorMessage="Please fill out this field." ForeColor="Red">
                                                </asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Agreement/Arrangement by PA">
                                            <ItemTemplate>
                                                <asp:Label ID="lblagreement_arrangement_pa" Text='<%# Bind("agreement_arrangement_pa") %>' runat="server" />

                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="agreement_arrangement_pa" Text='<%# Bind("agreement_arrangement_pa") %>' runat="server" MaxLength="200" Display="Dynamic" placeholder="Remarks" CssClass="form-control" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" Display="Dynamic" ControlToValidate="agreement_arrangement_pa" ErrorMessage="Please fill out this field." ForeColor="Red">
                                                </asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Agreement/Arrangement by other agency">
                                            <ItemTemplate>
                                                <asp:Label ID="lblother_agency" Text='<%# Bind("other_agency") %>' runat="server" />

                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="other_agency" Text='<%# Bind("other_agency") %>' runat="server" MaxLength="200" Display="Dynamic" placeholder="Remarks" CssClass="form-control" />
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" Display="Dynamic" ControlToValidate="other_agency" ErrorMessage="Please fill out this field." ForeColor="Red">
                                                </asp:RequiredFieldValidator>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
