<%@ Page Title="Van - Existing Corridors-Conservation Inputs Accomplished" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="CorridorsConservationInputsAccomplished.aspx.cs" Inherits="vansystem.CorridorsConservationInputsAccomplished" %>
...
<div class="form-group row">
    ...
    <div class="col-md-8">                                 
        <asp:TextBox class="form-control" placeholder="Target" TextMode="MultiLine" Rows="5" Columns="30" runat="server" maxlength="25" name="target" id="target" onkeypress="return isAlphabet(event)"></asp:TextBox>
    ...
    <label class="control-label col-md-3" style="margin-top: 11px;">Corridor Name<b class="text-danger">&nbsp;*</b></label>
    <div class="col-md-8">                                 
        <input class="form-control" placeholder="Corridor Name" type="text" runat="server" maxlength="25" name="corridor_name" id="Text7" onkeypress="return isAlphabet(event)"/>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="corridor_name" ErrorMessage="Please fill out this field." ForeColor="Red">
        </asp:RequiredFieldValidator>
    </div>
</div>--%>
                            <div class="form-group row">
    ...
    <div class="col-md-8">                                 
        <asp:TextBox class="form-control" placeholder="Agencies" TextMode="MultiLine" Rows="5" Columns="30" runat="server" maxlength="25" name="agencies" id="agencies" onkeypress="return isAlphabet(event)"></asp:TextBox>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ControlToValidate="agencies" ErrorMessage="Please fill out this field." ForeColor="Red">
                            ...
                            <div class="form-group row">
    <label class="control-label col-md-3" style="margin-top: 11px;">Achievement<b class="text-danger">&nbsp;*</b></label>
    <div class="col-md-8">                                 
        <asp:TextBox class="form-control" placeholder="Achievement" TextMode="MultiLine" Rows="5" Columns="30" runat="server" maxlength="25" name="achievement" id="achievement" onkeypress="return isAlphabet(event)"></asp:TextBox>
          <asp:RequiredFieldValidator ID="achievementvalidator" runat="server" ControlToValidate="achievement" ErrorMessage="Please fill out this field." ForeColor="Red">
        </asp:RequiredFieldValidator>
    </div>
</div>
    ...
    <div class="col-md-8">                                 
        <input class="form-control" placeholder="Constraints" type="text" runat="server" maxlength="25" name="constraints" id="constraints" onkeypress="return isAlphabet(event)"/>
