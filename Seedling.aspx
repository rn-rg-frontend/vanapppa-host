                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                ...
                                <asp:GridView ID="GVSeedling" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVSeedling_RowEditing" OnRowUpdating="GVSeedling_RowUpdating" OnPageIndexChanging="GVSeedling_PageIndexChanging" OnRowCancelingEdit="GVSeedling_RowCancelingEdit" OnRowDataBound="GVSeedling_RowDataBound" Style="width: 100%; margin-top: -1.25%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in cm)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txHeightcm" runat="server" Text='<%# Bind("height") %>' oninput="DecimalCheck(this)" onkeyup="delayedValidation2(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
