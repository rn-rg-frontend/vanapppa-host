...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; margin-top: 66px;">
                ...
                <%-- <marquee>
                 ...
                 <hr />
              <%--  <div class="card-body" id="cardBody" style="height: 100vh!important; overflow-y: auto; margin-left: 2%; width: 98% !important;">--%>
                                    ...
                                    <Columns>
                                       ...
                                       <%-- <asp:BoundField DataField="VillageId" ItemStyle-Width="150px" HeaderText="Village">
                                        ...
                                        <asp:TemplateField HeaderText="Legal Status">
                                            <ItemTemplate>
                                                <asp:Label ID="lbllegalStatus" runat="server" Text='<%#  TrimTo(Eval("LegalStatus"),30)%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
