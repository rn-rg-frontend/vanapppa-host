<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="AnnualFuelConsumption.aspx.cs" Inherits="vansystem.AnnualFuelConsumption" EnableEventValidation="false" %>
   ...
   <%-- <script>
    ...
    <script type="text/javascript">
        ...
        function checkFuelwoodValue5(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtc1q2Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue6(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtc2q2Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue7(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtc3q2Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue8(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtc4q2Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue9(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtd1q3Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue10(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtd2q3Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue11(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtd3q3Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue12(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txtd4q3Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue13(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txte1q4Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue14(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txte2q4Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue15(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txte3q4Source_of_fuelwood_collected');
        ...
        function checkFuelwoodValue16(input) {
            var fuelwoodValue = input.value;
            var sourceTextbox = document.getElementById('txte4q4Source_of_fuelwood_collected');
