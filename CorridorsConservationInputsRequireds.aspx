<%@ Page Title="Van - Existing Corridors-Conservation Inputs Required" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="CorridorsConservationInputsRequireds.aspx.cs" Inherits="vansystem.CorridorsConservationInputsRequireds" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Existing Corridors-Conservation Inputs Required</title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="CorridorsConservationInputsRequired.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add Existing Corridors-Conservation Inputs</a>
                    </div>
                                    ...
                                    <asp:GridView ID="GVgetuser" runat="server" AutoGenerateColumns="false" GridLines="Both" frame="void"
                                        ...
                                        <Columns>
                                           ...
                                           <%-- <asp:BoundField DataField="section" HeaderText="Section" ReadOnly="True"></asp:BoundField>--%>
                                            ...
                                            <asp:BoundField DataField="nature_of_inputs_treatment" HeaderText="Nature of inputs/treatment" ReadOnly="True"></asp:BoundField>
                                            <asp:BoundField DataField="target" HeaderText="Target" ReadOnly="True"></asp:BoundField>
                                            <asp:BoundField DataField="agencies" HeaderText="Agencies" ReadOnly="True"></asp:BoundField>
                                            <asp:BoundField DataField="constraints" HeaderText="Constraints" ReadOnly="True"></asp:BoundField>
                                            <asp:BoundField DataField="anticipated_investment" HeaderText="Anticipated investment (in lakhs)" ReadOnly="True"></asp:BoundField>
