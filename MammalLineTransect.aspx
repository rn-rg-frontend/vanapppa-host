<%@ Page Title="Van - Mammal Line Transect" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="MammalLineTransect.aspx.cs" Inherits="vansystem.MammalLineTransect" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Mammal Line Transect</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Mammal Line Transect</h3>
        ...
        <asp:BoundField DataField="transect_number" HeaderText="Transect Number" ReadOnly="True" />
        <asp:BoundField DataField="replicate" HeaderText="Replicate" ReadOnly="True" />
        <asp:BoundField DataField="bearing" HeaderText="Bearing" ReadOnly="True" />
        <asp:BoundField DataField="transect_length" HeaderText="Transect Length" ReadOnly="True" />
        ...
        <asp:BoundField DataField="species_name" HeaderText="Species Name" ReadOnly="True" />
        <asp:BoundField DataField="amale" HeaderText="Male Count" ReadOnly="True" />
        <asp:BoundField DataField="afemale" HeaderText="Female Count" ReadOnly="True" />
        <asp:BoundField DataField="ayoung" HeaderText="Young Count" ReadOnly="True" />
        <asp:BoundField DataField="atotal" HeaderText="Total Count" ReadOnly="True" />
        <asp:BoundField DataField="distance_from_transect" HeaderText="Distance from Transect" ReadOnly="True" />
        <asp:BoundField DataField="walk_bearing" HeaderText="Walk Bearing" ReadOnly="True" />
        <asp:BoundField DataField="animal_bearing" HeaderText="Animal Bearing" ReadOnly="True" />
        <asp:BoundField DataField="activity" HeaderText="Activity" ReadOnly="True" />
        <asp:BoundField DataField="ahabitat" HeaderText="Animal Habitat" ReadOnly="True" />
        <asp:BoundField DataField="aterrain" HeaderText="Animal Terrain" ReadOnly="True" />
