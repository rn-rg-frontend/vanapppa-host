<%@ Page Title="Van - Offence cases detected" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="DetectedOffenceCases.aspx.cs" Inherits="vansystem.DetectedOffenceCases" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Offence cases detected</title>
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="DetectedOffenceCase.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add offence cases detected</a>
                    </div>
                     <div class="pull-right">
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <asp:BoundField DataField="range" HeaderText="Range" ReadOnly="True" />
                                            ...
                                            <asp:BoundField DataField="schedule1" HeaderText="Schedule 1" ReadOnly="True" />
                                            <asp:BoundField DataField="schedule2" HeaderText="Schedule 2" ReadOnly="True" />
                                            <asp:BoundField DataField="schedule3" HeaderText="Schedule 3" ReadOnly="True" />
                                            <asp:BoundField DataField="schedule4" HeaderText="Schedule 4" ReadOnly="True" />
                                            <asp:BoundField DataField="schedule_others" HeaderText="Schedule others" ReadOnly="True" />
       <%-- <asp:BoundField DataField="latitude" HeaderText="Latitude" ReadOnly="True" />
        ...
        <asp:BoundField DataField="successful_convicted" HeaderText="Successful (Convicted)" ReadOnly="True" />
        <asp:BoundField DataField="failure_acquitted" HeaderText="Failure (Acquitted)" ReadOnly="True" />
        <asp:BoundField DataField="cases_under_process" HeaderText="Cases Under Process" ReadOnly="True" />
        <asp:BoundField DataField="cases_compounded" HeaderText="Cases Compounded" ReadOnly="True" />
