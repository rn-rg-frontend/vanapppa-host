    ...
    <div class="container-fluid mt-6">
                            ...
                            <asp:GridView ID="gvVLI" runat="server" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" DataKeyNames="id" GridLines="Horizontal" OnRowCancelingEdit="gvVLI_RowCancelingEdit" OnRowEditing="gvVLI_RowEditing" OnRowUpdating="gvVLI_RowUpdating" OnRowDataBound="gvVLI_RowDataBound" AllowPaging="true" PageSize="10" OnPageIndexChanging="gvVLI_PageIndexChanging" OnRowCommand="gvVLI_RowCommand" OnPreRender="gvVLI_PreRender">
                                ...
                                <columns>
                                    ...
                                    <asp:TemplateField HeaderText="Buffer/Stratum" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                            <asp:Label ID="lblBuffer" runat="server" Text='<%# TrimTo(Eval("buffer"),30) %>'></asp:Label>
                                        </itemtemplate>
                                        <headerstyle horizontalalign="Center" />
                                        <itemstyle width="20%" />
                                    ...
                                    <asp:TemplateField HeaderText="Other Rights Over Forest Resources(cbOtherRights)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Other Rights Over Forest Resources(etOtherRightsName)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Other Rights Over Forest Resources(etOtherRightsNumber)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Others (not Specified in Above Categories(cbOtherNotSpecified))" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Others (not Specified in Above Categories(etOtherNotSpecifiedName))" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Others (not Specified in Above Categories(etOtherNotSpecifiedNumber))" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Other (Specify(cbOtherDrinkingSource))" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Other (Specify(etOtherDrinkingSourceName))" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Other (Specify(etOtherDrinkingSourceNumber))" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Any Other Specify(cbOtherIrrigation)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Any Other Specify(etOtherIrrigationName)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Any Other Specify(etOtherIrrigationNumber)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Duration of Water Available Flow (months)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <edititemtemplate>
                                            <asp:TextBox Enabled='<%# !string.IsNullOrEmpty(Eval("ponds_duration").ToString()) %>' onkeydown="return Search_Gridview(event)" ID="txtponds_duration" runat="server" Text='<%# Eval("ponds_duration") %>' Width="140" oninput="validateDuration(this)"></asp:TextBox>
                                        </edititemtemplate>
                                        <headerstyle horizontalalign="Center" />
                                        <itemstyle width="20%" />
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Duration of Water Available Flow (Months)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <edititemtemplate>
                                            <asp:TextBox Enabled='<%# !string.IsNullOrEmpty(Eval("wells_duration").ToString()) %>' onkeydown="return Search_Gridview(event)" ID="txtwells_duration" runat="server" Text='<%# Eval("wells_duration") %>' Width="140" oninput="validateDuration(this)"></asp:TextBox>
                                        </edititemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Name of Informant" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <edititemtemplate>
                                            <asp:TextBox Enabled='<%# !string.IsNullOrEmpty(Eval("informant_name").ToString()) %>' onkeydown="return Search_Gridview(event)" ID="txtinformant_name" runat="server" Text='<%# Eval("business") %>' Width="140" oninput="SplCharCheck(this)"></asp:TextBox>
                                        </edititemtemplate>
                                        <headerstyle horizontalalign="Center" />
                                        <itemstyle width="20%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Type of Informant" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <edititemtemplate>
                                            <asp:TextBox Enabled='<%# !string.IsNullOrEmpty(Eval("informant_type").ToString()) %>' onkeydown="return Search_Gridview(event)" ID="txtinformant_type" runat="server" Text='<%# Eval("business") %>' Width="140" oninput="SplCharCheck(this)"></asp:TextBox>
                                        </edititemtemplate>
                                        <headerstyle horizontalalign="Center" />
                                        <itemstyle width="20%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Type of Informant(etOtherInformantType)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        <itemtemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Occupation" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <edititemtemplate>
                                            <asp:TextBox Enabled='<%# !string.IsNullOrEmpty(Eval("occupation").ToString()) %>' onkeydown="return Search_Gridview(event)" ID="txtoccupation" runat="server" Text='<%# Eval("occupation") %>' Width="140" oninput="SplCharCheck(this)"></asp:TextBox>
                                        </edititemtemplate>
                                        <headerstyle horizontalalign="Center" />
                                        <itemstyle width="20%" />
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Education" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <edititemtemplate>
                                            <asp:TextBox Enabled='<%# !string.IsNullOrEmpty(Eval("education").ToString()) %>' onkeydown="return Search_Gridview(event)" ID="txteducation" runat="server" Text='<%# Eval("education") %>' Width="140" oninput="SplCharCheck(this)"></asp:TextBox>
                                        </edititemtemplate>
                                        <headerstyle horizontalalign="Center" />
                                        <itemstyle width="20%" />
                                    </asp:TemplateField>
        ...
        function isNumberKey(evt) {
            ...
            function validateDuration(input) {
                ...
                var duration = parseInt(input.value);

                // Check if the value is less than 1 or greater than 12
                if (duration < 1 || duration > 12) {
                    // If the value is invalid, reset the input
                    input.value = '';
                    // Optionally, you can display an error message to the user
                    // alert('Duration should be a number between 1 and 12.');
                }
            }
