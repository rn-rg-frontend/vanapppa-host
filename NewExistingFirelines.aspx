<%@ Page Title="Van - New/Existing Firelines" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="NewExistingFirelines.aspx.cs" Inherits="vansystem.NewExistingFirelines" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - New/Existing Firelines</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="app-content">
            ...
            <div class="col-md-12 col-sm-12">
                <div class="tile" style="margin-left: -10px;">
                    <div class="pull-right">
                        <a href="NewExistingFireline.aspx" class="btn btn-xs btn-primary"><i class="fa fa-plus-circle"></i>Add New/Existing Firelines </a>
                    </div>
                    <h3 class="tile-title">New/Existing Firelines</h3>
        ...
        <asp:BoundField DataField="width" HeaderText="Width (in meters)" ReadOnly="True" />
        <asp:BoundField DataField="length" HeaderText="Length (in kms)" ReadOnly="True" />
        <asp:BoundField DataField="points_connected_name" HeaderText="Name of Points Connected" ReadOnly="True" />
        <asp:BoundField DataField="cost" HeaderText="Cost (in lakhs)" ReadOnly="True" />
