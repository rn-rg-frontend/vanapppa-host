<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="StaticStump.aspx.cs" Inherits="vansystem.StaticStump" %>
                                ...
                                <asp:GridView ID="GVStump" runat="server" AutoGenerateColumns="false" OnRowEditing="GVStump_RowEditing" OnRowUpdating="GVStump_RowUpdating" OnPageIndexChanging="GVStump_PageIndexChanging" OnRowCancelingEdit="GVStump_RowCancelingEdit" OnRowDataBound="GVStump_RowDataBound" ShowHeaderWhenEmpty="true" Style="width: 100%" DataKeyNames="id" AllowPaging="true">
                                    ...
                                    <Columns>
                                       ...
                                       <asp:TemplateField HeaderText="Status of Stump" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                        ...
                                        <asp:TemplateField HeaderText="Stump Diameter (in cm)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Stump Height (in cm)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
