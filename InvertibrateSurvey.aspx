<%@ Page Title="Van - Invertibrate Survey" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="InvertibrateSurvey.aspx.cs" Inherits="vansystem.InvertibrateSurvey" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Invertibrate Survey</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Invertibrate Survey</h3>
        ...
        <asp:BoundField DataField="forest" HeaderText="Forest" ReadOnly="True" />
        ...
        <asp:BoundField DataField="elatitude" HeaderText="End Latitude" ReadOnly="True" />
        <asp:BoundField DataField="elongitude" HeaderText="End Longitude" ReadOnly="True" />
        <asp:BoundField DataField="ealtitude" HeaderText="End Altitude" ReadOnly="True" />
        <asp:BoundField DataField="eaccuracy" HeaderText="End Accuracy" ReadOnly="True" />
        <asp:BoundField DataField="mammals" HeaderText="Mammals" ReadOnly="True" />
        <asp:BoundField DataField="birds" HeaderText="Birds" ReadOnly="True" />
        ...
        <asp:BoundField DataField="mammals_comments" HeaderText="Mammals Comments" ReadOnly="True" />
        <asp:BoundField DataField="birds_comments" HeaderText="Birds Comments" ReadOnly="True" />
        ...
        <asp:BoundField DataField="mammals_others" HeaderText="Mammals Others" ReadOnly="True" />
        <asp:BoundField DataField="birds_others" HeaderText="Birds Others" ReadOnly="True" />
        <asp:BoundField DataField="reptiles_others" HeaderText="Reptiles Others" ReadOnly="True" />
        <asp:BoundField DataField="amphibians_others" HeaderText="Amphibians Others" ReadOnly="True" />
        ...
        <asp:BoundField DataField="etime" HeaderText="Detail End Time" ReadOnly="True" />
        <asp:BoundField DataField="elatitude" HeaderText="Detail End Latitude" ReadOnly="True" />
        <asp:BoundField DataField="elongitude" HeaderText="Detail End Longitude" ReadOnly="True" />
        <asp:BoundField DataField="ealtitude" HeaderText="Detail End Altitude" ReadOnly="True" />
        <asp:BoundField DataField="eaccuracy" HeaderText="Detail End Accuracy" ReadOnly="True" />
