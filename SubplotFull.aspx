<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="SubplotFull.aspx.cs" Inherits="vansystem.SubplotFull" %>
            ...
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <%--  <asp:LinkButton runat="server" ID="subplotdata" class="btn btn-xs btn-success" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="subplotdata_Command" Text="Sub Plot"> </asp:LinkButton>--%>
                ...
                <div class="card-body" style="height: 63vh!important; overflow-y: auto; margin-left: 2%; width: 99%;">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">

                                <asp:GridView ID="GVSub" runat="server" HeaderStyle-Width="10%" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true"  Style="width: 100%; margin-top: -1%" OnPageIndexChanging="GVSub_PageIndexChanging" PageSize="10" AllowPaging="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Sub plots">
                                            <ItemTemplate>
                                         ...
                                         <asp:TemplateField HeaderText="Total number of trees">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltotalNumberOfTrees" runat="server" Text='<%# Eval("totalNumberOfTrees")%>'></asp:Label>
                                            </ItemTemplate>
                                            <%-- <EditItemTemplate>
                                                <asp:DropDownList ID="ddldirection" runat="server">
                                                </asp:DropDownList>
