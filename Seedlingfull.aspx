        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3 id="stickyHeader"><b>Plot Enumeration-Seedling</b></h3>
                    </div>
                                ...
                                <asp:GridView ID="GVSeedling" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVSeedling_RowEditing" OnRowUpdating="GVSeedling_RowUpdating" OnPageIndexChanging="GVSeedling_PageIndexChanging" OnRowCancelingEdit="GVSeedling_RowCancelingEdit" OnRowDataBound="GVSeedling_RowDataBound" Style="width: 100%;" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Average number" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lbltotalnos" runat="server" Text='<%# Eval("totalnos") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txttotalnos" runat="server" Text='<%# Eval("totalnos") %>' Width="140" oninput="DecimalCheck(this);" onkeydown="return Search_Gridview(event)"></asp:TextBox>
