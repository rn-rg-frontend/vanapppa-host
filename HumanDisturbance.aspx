<%@ Page Title="Van - Human Disturbance" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="HumanDisturbance.aspx.cs" Inherits="vansystem.HumanDisturbance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <title>Van - Human Disturbance</title>
...
<asp:Button ID="btnExportToExcel" class="btn btn-xs btn-primary" runat="server" Text="Download Excel" OnClick="btnExportToExcel_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <h3 class="tile-title">Human Disturbance</h3>
        ...
        <asp:BoundField DataField="nowoods" HeaderText="No Woods" ReadOnly="True" />
        <asp:BoundField DataField="notreelopping" HeaderText="No Tree Lopping" ReadOnly="True" />
        <asp:BoundField DataField="notrail" HeaderText="No Trail" ReadOnly="True" />
        <asp:BoundField DataField="nopeopleseen" HeaderText="No People Seen" ReadOnly="True" />
        <asp:BoundField DataField="nolivestockseen" HeaderText="No Livestock Seen" ReadOnly="True" />
        <asp:BoundField DataField="grass" HeaderText="Grass" ReadOnly="True" />
        <asp:BoundField DataField="bamboo" HeaderText="Bamboo" ReadOnly="True" />
        <asp:BoundField DataField="human" HeaderText="Human" ReadOnly="True" />
        <asp:BoundField DataField="fire" HeaderText="Fire" ReadOnly="True" />
        <asp:BoundField DataField="nosettlements" HeaderText="No Settlements" ReadOnly="True" />
        <asp:BoundField DataField="humanpopulation" HeaderText="Human Population" ReadOnly="True" />
        <asp:BoundField DataField="livestockpopulation" HeaderText="Livestock Population" ReadOnly="True" />
        <asp:BoundField DataField="cattle" HeaderText="Cattle" ReadOnly="True" />
        <asp:BoundField DataField="goat" HeaderText="Goat" ReadOnly="True" />
        <asp:BoundField DataField="otlivestock" HeaderText="Other Livestock" ReadOnly="True" />
        <asp:BoundField DataField="ntfp" HeaderText="NTFP" ReadOnly="True" />
        <asp:BoundField DataField="ntfps" HeaderText="NTFPs" ReadOnly="True" />
