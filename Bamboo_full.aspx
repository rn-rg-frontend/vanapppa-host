...
/*
    ...
    <script type="text/javascript">
        ...
        //function delayedValidation3(textBox) {
        //    clearTimeout(timer2);
        ...
        //    }, 500);
        //}
        //function delayedValidation4(textBox) {
        //    clearTimeout(timer2);
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3 id="stickyHeader"><b>Plot Enumeration-Bamboo</b></h3>
                    ...
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="Bamboo" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Bamboo_Command" Text="Bamboo"> </asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVBamboo" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id,PlotEnumerationId" OnRowEditing="GVBamboo_RowEditing" OnRowCancelingEdit="GVBamboo_RowCancelingEdit" OnRowUpdating="GVBamboo_RowUpdating" OnRowDataBound="GVBamboo_RowDataBound" Style="width: 100%" OnPageIndexChanging="GVBamboo_PageIndexChanging" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Select corner plot">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldirection" runat="server" Text='<%# Eval("bamboodatadirection")%>'></asp:Label>
                                            </ItemTemplate>
                                            <%--  <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Specify other" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbamboonumber" runat="server" Text='<%# Eval("othername") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtbamboonumber" runat="server" Text='<%# Eval("othername") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Diameter of Bamboo Clump (in m)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbamboodiameter" runat="server" Text='<%# Eval("bamboodiameter") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtbamboodiameter" runat="server" Text='<%# Eval("bamboodiameter") %>' Width="140" oninput="DecimalCheck(this);" onkeyup="delayedValidation1(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>
                                        </asp:TemplateField>


                                        <asp:TemplateField HeaderText="No. of Bamboo Culms" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbambooculms" runat="server" Text='<%# Eval("bambooculms") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtbambooculms" runat="server" Text='<%# Eval("bambooculms") %>' Width="140" oninput="DecimalCheck(this);" onkeyup="delayedValidation2(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="GBH" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbamboogbh" runat="server" Text='<%# Eval("bamboogbh") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtbamboogbh" runat="server" Text='<%# Eval("bamboogbh") %>' Width="140" oninput="DecimalCheck(this);" onkeyup="delayedValidation2(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in meters)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbambooheight" runat="server" Text='<%# Eval("bambooheight") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtbambooheight" runat="server" Text='<%# Eval("bambooheight") %>' Width="140" oninput="DecimalCheck(this);" onkeyup="delayedValidation1(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Remarks if any (in m)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblbambooremarks" runat="server" Text='<%# Eval("bambooremarks") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtbambooremarks" runat="server" Text='<%# Eval("bambooremarks") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
