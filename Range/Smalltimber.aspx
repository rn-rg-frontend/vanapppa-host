<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Smalltimber.aspx.cs" Inherits="vansystem.Range.Smalltimber" %>
            ...
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="d-md-flex justify-content-between text-center align-items-center">
                    <div style="margin-left: 3% !important;">
                        <h3 style="margin-left: 60px !important; margin-inline: auto;"><b>Annual Small Timber Consumption</b></h3>
                    </div>
                    ...
                    <asp:UpdatePanel runat="server" ID="updatepanel2">
                        <ContentTemplate>
                            <div class="box-content" style="display: flex; align-items: center;">
                                ...
                                <asp:GridView ID="gvsmalltimber" runat="server" AutoGenerateColumns="False" DataKeyNames="id" GridLines="Horizontal" OnRowCancelingEdit="gvsmalltimber_RowCancelingEdit" OnRowEditing="gvsmalltimber_RowEditing" OnRowUpdating="gvsmalltimber_RowUpdating" AllowPaging="true" PageSize="10" OnPageIndexChanging="gvsmalltimber_PageIndexChanging" OnRowDataBound="gvsmalltimber_RowDataBound" OnPreRender="gvsmalltimber_PreRender" OnRowCommand="gvsmalltimber_RowCommand" ShowHeaderWhenEmpty="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Plough(Hal) Number" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="200%">
                                            <ItemTemplate>
                                        ...
                                        <%--<asp:TemplateField HeaderText="RFO Approve" ShowHeader="False">
                                              <ItemTemplate>
                                                  <asp:Button ID="Button3" runat="server" CausesValidation="false" CommandName="" Text=" Approve" />
                                              </ItemTemplate>
                                          </asp:TemplateField>--%>
                                    </Columns>
