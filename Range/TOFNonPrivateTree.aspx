<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="TOFNonPrivateTree.aspx.cs" Inherits="vansystem.Range.TOFNonPrivateTree" %>
    ...
    <div <%--class="card" style="height: 826px; background-color: #EFEFEF"--%>>
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="d-md-flex justify-content-between align-items-end text-center pb-4">
                    <div style="margin-left: 3% !important;">
                        <h3 style="margin-inline: auto; margin-left: 40px;"><b>Assessment Of TOF In Non-Private Land-Tree(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                    <div class="row d-sm-flex justify-content-center align-items-center text-center">
                        <div>
                            <asp:LinkButton runat="server" ID="masterdata" class="btn btn-xs btn-success" CommandArgument='<%# Eval("Id") %>' OnCommand="masterdata_Command" Style="" Text="Master Data"> </asp:LinkButton>
                ...
                <div class="card-body" style="background-color: rgb(252, 252, 252); margin-left: 60px; overflow: scroll; height: 75vh; padding: 0.5%; margin-right: 24%">
                    <div class="box-content">
                        <asp:GridView ID="GVnonprivatelandTree" runat="server" HeaderStyle-Width="10%" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowCancelingEdit="GVnonprivatelandTree_RowCancelingEdit" OnRowEditing="GVnonprivatelandTree_RowEditing" OnRowUpdating="GVnonprivatelandTree_RowUpdating" Style="width: 100%; margin-top: -1%" OnPageIndexChanging="GVnonprivatelandTree_PageIndexChanging">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField ItemStyle-Width="150px" DataField="Id" HeaderStyle-Width="10%" HeaderText="Survey ID" ReadOnly="true"></asp:BoundField>
