<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Shrub.aspx.cs" Inherits="vansystem.Range.Shrub" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3><b>Plot Enumeration-Shrub(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="Shurb" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Shurb_Command" Text="Shrub"> </asp:LinkButton>
                                ...
                                <asp:GridView ID="GVShurb" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" OnRowEditing="GVShurb_RowEditing" OnRowUpdating="GVShurb_RowUpdating" OnPageIndexChanging="GVShurb_PageIndexChanging" OnRowCancelingEdit="GVShurb_RowCancelingEdit" OnRowDataBound="GVShurb_RowDataBound" DataKeyNames="id" AllowPaging="true" PageSize="10" Style="width: 100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Select corner plot">
                                            <ItemTemplate>
                                                <asp:Label ID="lblshrubdatadirection" runat="server" Text='<%# Eval("shrubdatadirection")%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
