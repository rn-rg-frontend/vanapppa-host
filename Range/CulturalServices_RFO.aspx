<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="CulturalServices_RFO.aspx.cs" Inherits="vansystem.Range.CulturalServices_RFO" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
              ...
              <div class="card-body" id="cardBody" style="height: 100vh!important; overflow-y: auto; margin-left: 3.5rem !important; width: 98%; ">
                    <asp:UpdatePanel runat="server" ID="updatepanel1">
                        <ContentTemplate>
                            ...
                            <div class="box-content" style="display: flex; align-items: center; margin-top: -10px">
                                <asp:GridView ID="GVCultural" DataKeyNames="CulturalServicesId" runat="server" AutoGenerateColumns="False" OnPageIndexChanging="GVCultural_PageIndexChanging" AllowPaging="True" Style="width: 100%" ShowHeaderWhenEmpty="True" OnRowCommand="GVCultural_RowCommand" OnRowDataBound="GVCultural_RowDataBound">
                                    ...
                                    <asp:TemplateField HeaderText="Survey Id" Visible="false">
                                        <EditItemTemplate>
                                        ...
                                        <%-- <asp:BoundField ItemStyle-Width="150px" DataField="ik_type" HeaderText="Type of Indegenous/Traditional Knowledge">
                                        <ItemStyle Width="150px" />
                                    </asp:BoundField>--%>
    ...
    <script type="text/javascript">
        ...
        function initializeMultiselect() {
            $('[id*=lstselected_month]').multiselect({
                includeSelectAllOption: true
            });
        }

        function initializeMultiselect1() {
            $('[id*=lstso_selected_month]').multiselect({
                includeSelectAllOption: true
            });
        }
