<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Climber.aspx.cs" Inherits="vansystem.Range.Climber" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3><b>Plot Enumeration-Climber(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="Climber" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Climber_Command" Text="Climber"> </asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                ...
                                <asp:GridView ID="GVClimber" runat="server" DataKeyNames="id" ShowHeaderWhenEmpty="true" OnRowEditing="GVClimber_RowEditing" OnRowDataBound="GVClimber_RowDataBound" OnRowUpdating="GVClimber_RowUpdating" AutoGenerateColumns="false" Style="width: 100%" AllowPaging="true" PageSize="10" OnPageIndexChanging="GVClimber_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Average number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txAverageNumber" runat="server" Text='<%# Bind("climbernumber") %>' oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbAverageNumber" runat="server" Text='<%# Bind("climbernumber") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
