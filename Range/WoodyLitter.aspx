<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="WoodyLitter.aspx.cs" Inherits="vansystem.Range.WoodyLitter" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVWoodylitter" runat="server" AutoGenerateColumns="false" OnRowEditing="GVWoodylitter_RowEditing" OnRowDataBound="GVWoodylitter_RowDataBound" OnRowUpdating="GVWoodylitter_RowUpdating" OnPageIndexChanging="GVWoodylitter_PageIndexChanging" ShowHeaderWhenEmpty="true" OnRowCancelingEdit="GVWoodylitter_RowCancelingEdit" Style="width: 100%" DataKeyNames="id" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Woody litter weight (in Grams)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtwoody_litter_weight_in_grams" runat="server" Text='<%# Bind("woody_litter_weight_in_grams") %>' oninput="DecimalCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbWoodyLitterWeight" runat="server" Text='<%# Bind("woody_litter_weight_in_grams") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Sample weight">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtsub_sample_weight" runat="server" Text='<%# Bind("sub_sample_weight") %>' oninput="DecimalCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
