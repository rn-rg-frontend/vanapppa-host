<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Seedlingfull.aspx.cs" Inherits="vansystem.Range.Seedlingfull" %>
                                ...
                                <asp:GridView ID="GVSeedling" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVSeedling_RowEditing" OnRowUpdating="GVSeedling_RowUpdating" OnPageIndexChanging="GVSeedling_PageIndexChanging" OnRowCancelingEdit="GVSeedling_RowCancelingEdit" OnRowDataBound="GVSeedling_RowDataBound" Style="width: 100%;" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Average number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txAverageNumber" runat="server" Text='<%# Bind("totalnos") %>' oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in cm)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txHeightcm" runat="server" Text='<%# Bind("height") %>' oninput="DecimalCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
