<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="vansystem.Range.About" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Van - About</title>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <asp:Panel ID="loginSuccessAlert" runat="server" Visible="false">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
							...
							<ol>
                                ...
                                <li>A cloud-based data repository.</li>
