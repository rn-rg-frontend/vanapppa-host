<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="PlotEnumeration.aspx.cs" Inherits="vansystem.Range.PlotEnumeration" %>
                                        ...
                                        <asp:TemplateField HeaderText="Stump" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                         ...
                                         <asp:TemplateField HeaderText="Non Clump" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton runat="server" class="btn btn-xs btn-success" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="NonClump_link" Text="NonClump"> </asp:LinkButton>
    ...
    <script type="text/javascript">
        function Search_function(strKey) {
            ...
            if (!messageElement) {
                ...
                messageElement.style.color = 'red';
                //messageElement.style.paddingBottom = '13%';
                //messageElement.style.overflowY = 'clip';
                tblData.parentElement.appendChild(messageElement);
            }
