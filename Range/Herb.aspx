<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Herb.aspx.cs" Inherits="vansystem.Range.Herb" %>
    ...
    <div <%--class="card" style="height: 826px; background-color: #EFEFEF"--%>>
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="card-body" style="height: 100vh!important; overflow-y: auto; margin-left: 2.3%;">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>

                            <div class="box-content">

                                <asp:GridView ID="GVHerb" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVHerb_RowEditing" OnRowUpdating="GVHerb_RowUpdating" OnPageIndexChanging="GVHerb_PageIndexChanging" OnRowCancelingEdit="GVHerb_RowCancelingEdit" OnRowDataBound="GVHerb_RowDataBound" Style="width: 100%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Specify other" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblherbnum" runat="server" Text='<%# Eval("herbnum") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtherbnum" runat="server" Text='<%# Eval("herbnum") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Approx. weight of NTFP in grams" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                           ...
                                           <%-- <EditItemTemplate>
                                                <asp:TextBox ID="txtapprox" runat="server" Text='<%# Eval("approx") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks if any" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtremark" runat="server" Text='<%# Eval("remark") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>
