<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Treefull.aspx.cs" Inherits="vansystem.Range.Treefull" %>
                                ...
                                <asp:GridView ID="GVTree" runat="server" HeaderStyle-Width="10%" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id,PlotEnumerationId" OnRowCancelingEdit="GVTree_RowCancelingEdit" OnRowEditing="GVTree_RowEditing" OnRowUpdating="GVTree_RowUpdating" OnPageIndexChanging="GVTree_PageIndexChanging" PageSize="10" AllowPaging="true" OnRowDataBound="GVTree_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Specify other">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtSpecifyOther" runat="server" Text='<%# Bind("othername") %>' onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                    ...
                                    <ItemStyle Width="150px"></ItemStyle>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks if any (in meters)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
