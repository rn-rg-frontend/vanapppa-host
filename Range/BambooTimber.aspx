<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="BambooTimber.aspx.cs" Inherits="vansystem.Range.BambooTimber" %>
            ...
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="d-md-flex justify-content-between text-center align-items-center">
                    <div style="margin-left: 3% !important;">
                        <h3 style="margin-left: 60px !important; margin-inline: auto;"><b>Annual Bamboo Consumption</b></h3>
                    </div>
