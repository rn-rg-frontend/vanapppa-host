<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Climberfull.aspx.cs" Inherits="vansystem.Range.Climberfull" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3 id="stickyHeader"><b>Plot Enumeration-Climber</b></h3>
                    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                ...
                                <asp:GridView ID="GVClimber" runat="server" DataKeyNames="id,PlotEnumerationId" ShowHeaderWhenEmpty="true" OnRowEditing="GVClimber_RowEditing" OnRowUpdating="GVClimber_RowUpdating" OnRowCancelingEdit="GVClimber_RowCancelingEdit" OnRowDataBound="GVClimber_RowDataBound" AutoGenerateColumns="false" Style="width: 100%" AllowPaging="true" PageSize="10" OnPageIndexChanging="GVClimber_PageIndexChanging">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Average Number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtclimbernumber" runat="server" Text='<%# Bind("climbernumber") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lblclimbernumber" runat="server" Text='<%# Bind("climbernumber") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
