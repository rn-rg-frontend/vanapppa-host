<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Saplingfull.aspx.cs" Inherits="vansystem.Range.Saplingfull" %>
                ...
                <div class="card-body" style="background-color: rgb(252, 252, 252); overflow: scroll">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            ...
                            <div class="box-content" style="margin-top: -1%">
                                <asp:GridView ID="GVSapling" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVSapling_RowEditing" OnRowUpdating="GVSapling_RowUpdating" OnPageIndexChanging="GVSapling_PageIndexChanging" OnRowCancelingEdit="GVSapling_RowCancelingEdit" OnRowDataBound="GVSapling_RowDataBound" Style="width: 100%" AllowPaging="true" PageSize="10" OnRowCommand="GVSapling_RowCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Collar girth at base" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:Label ID="lblcollardiameter" runat="server" Text='<%# Eval("collardiameter") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtcollardiameter" runat="server" Text='<%# Eval("collardiameter") %>' oninput="DecimalCheck(this);"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in cm)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtheight" runat="server" Text='<%# Eval("height") %>' Width="140" oninput="DecimalCheck(this);"></asp:TextBox>
                        ...
                        <Triggers>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="GVSapling" EventName="RowEditing" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
