<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="DeadWood.aspx.cs" Inherits="vansystem.Range.DeadWood" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3><b>Plot Enumeration-DeadWood(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="DeadWood" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="DeadWood_Command" Text="Dead Wood"> </asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVDeadWood" runat="server" AutoGenerateColumns="False" DataKeyNames="id" OnRowEditing="GVDeadWood_RowEditing" OnRowUpdating="GVDeadWood_RowUpdating" OnPageIndexChanging="GVDeadWood_PageIndexChanging" OnRowDataBound="GVDeadWood_RowDataBound" ShowHeaderWhenEmpty="True" OnRowCancelingEdit="GVDeadWood_RowCancelingEdit" Style="width: 100%" AllowPaging="True">
                                    ...
                                    <Columns>
                                        ...
                                        <%-- <asp:BoundField ItemStyle-Width="150px" DataField="dead_wood_weight_in_grams"  HeaderText="Dead wood weight (in Grams)">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>--%>

                                        <asp:TemplateField HeaderText="Dead wood weight (in Grams)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txDeadWoodWeght" runat="server" Text='<%# Bind("dead_wood_weight_in_grams") %>' oninput="DecimalCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbDeadWoodWeght" runat="server" Text='<%# Bind("dead_wood_weight_in_grams") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Sample weight">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txSampleWeight" runat="server" Text='<%# Bind("sub_sample_weight") %>' oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Sample Number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txSampleNumber" runat="server" Text='<%# Bind("sample_plot_number") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbSampleNumber" runat="server" Text='<%# Bind("sample_plot_number") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
