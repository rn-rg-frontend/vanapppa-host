<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Bamboo.aspx.cs" Inherits="vansystem.Range.Bamboo" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function delayedValidation(textBox) {
            ...
            }, 500); // Delay validation by 500 milliseconds
        }
                                ...
                                <asp:GridView ID="GVBamboo" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVBamboo_RowEditing" OnRowCancelingEdit="GVBamboo_RowCancelingEdit" OnRowUpdating="GVBamboo_RowUpdating" OnRowDataBound="GVBamboo_RowDataBound" OnPageIndexChanging="GVBamboo_PageIndexChanging" AllowPaging="true" Style="width: 100%; margin-top: -1%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Specify other">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtSpecifyOther" runat="server" Text='<%# Bind("othername") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Diameter of Bamboo Clump (in m)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtDiameter" runat="server" Text='<%# Bind("bamboodiameter") %>' oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="No. of Bamboo Culms">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtNoOfBambooCulms" runat="server" Text='<%# Bind("bambooculms") %>' oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in meters)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtHeight" runat="server" Text='<%# Bind("bambooheight") %>' oninput="NumberCheck(this)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Remarks if any">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txRemark" runat="server" Text='<%# Bind("bambooremarks") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
