<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Leaflitter.aspx.cs" Inherits="vansystem.Range.Leaflitter" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3><b>Plot Enumeration-Leaf  Litter(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="LeafLitter" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="LeafLitter_Command" Text="Leaf Litter"> </asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVLeaflitter" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVLeaflitter_RowEditing" OnRowUpdating="GVLeaflitter_RowUpdating" OnPageIndexChanging="GVLeaflitter_PageIndexChanging" ShowHeaderWhenEmpty="true" OnRowDataBound="GVLeaflitter_RowDataBound" OnRowCancelingEdit="GVLeaflitter_RowCancelingEdit" Style="width: 100%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:BoundField ItemStyle-Width="150px" DataField="leaf_litter_weight_in_grams" HeaderText="Leaf litter weight (in Grams)">
                                            <ItemStyle Width="150px"></ItemStyle>
                                        </asp:BoundField>--%>

                                        <asp:TemplateField HeaderText="Leaf litter weight (in Grams)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtleaf_litter_weight_in_grams" runat="server" Text='<%# Bind("leaf_litter_weight_in_grams") %>' oninput="DecimalCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbLeafLitterWeight" runat="server" Text='<%# Bind("leaf_litter_weight_in_grams") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Sample weight">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtsub_sample_weight" runat="server" Text='<%# Bind("sub_sample_weight") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbSampleWeight" runat="server" Text='<%# Bind("sub_sample_weight") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Sample Number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtsample_number" runat="server" Text='<%# Bind("sample_number") %>' onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbSampleNumber" runat="server" Text='<%# Bind("sample_number") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>


                                        <asp:TemplateField HeaderText="Remarks (if any)" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblremarks" runat="server" Text='<%# Eval("remarks") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtremarks" runat="server" Text='<%# Eval("remarks") %>' onkeydown="return Search_Gridview(event)" Width="140"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
