<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Seedling.aspx.cs" Inherits="vansystem.Range.Seedling" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <div>
                            <h3><b style="position: sticky">Plot Enumeration-Seedling(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                        </div>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="Seedling" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Seedling_Command" Text="Seedling"> </asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                ...
                                <%--<asp:GridView ID="GVSeedling" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnPageIndexChanging="GVSeedling_PageIndexChanging" Style="width: 100%;" AllowPaging="true" PageSize="10">--%>

                                <asp:GridView ID="GVSeedling" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id" OnRowEditing="GVSeedling_RowEditing" OnRowUpdating="GVSeedling_RowUpdating" OnPageIndexChanging="GVSeedling_PageIndexChanging" OnRowCancelingEdit="GVSeedling_RowCancelingEdit" OnRowDataBound="GVSeedling_RowDataBound" Style="width: 100%;" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Specify other">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtSpecifyOther" runat="server" Text='<%# Bind("seedlingnum") %>' oninput="SplCharCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbSpecifyOther" runat="server" Text='<%# Bind("seedlingnum") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Average number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txAverageNumber" runat="server" Text='<%# Bind("totalnos") %>' oninput="NumberCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="lbAverageNumber" runat="server" Text='<%# Bind("totalnos") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in cm)">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txHeightcm" runat="server" Text='<%# Bind("height") %>' oninput="DecimalCheck(this)" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
