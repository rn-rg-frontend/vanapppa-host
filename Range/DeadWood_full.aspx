<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="DeadWood_full.aspx.cs" Inherits="vansystem.Range.DeadWood_full" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3 id="stickyHeader"><b>Plot Enumeration-Dead Wood</b></h3>
                    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVDeadWood" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVDeadWood_RowEditing" OnRowUpdating="GVDeadWood_RowUpdating" OnPageIndexChanging="GVDeadWood_PageIndexChanging" ShowHeaderWhenEmpty="true" OnRowCancelingEdit="GVDeadWood_RowCancelingEdit" OnRowDataBound="GVDeadWood_RowDataBound" Style="width: 100%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Select corner plot">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldirection" runat="server" Text='<%# Eval("direction_names")%>' onkeydown="return Search_Gridview(event)"></asp:Label>
                                            </ItemTemplate>
                                            <%-- <EditItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Dead wood weight (in Grams)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldead_wood_weight_in_grams" runat="server" Text='<%# Eval("dead_wood_weight_in_grams") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtdead_wood_weight_in_grams" runat="server" Text='<%# Eval("dead_wood_weight_in_grams") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Sample Number" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblsample_plot_number" runat="server" Text='<%# Eval("sample_plot_number") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtsample_plot_number" runat="server" Text='<%# Eval("sample_plot_number") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
