<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Herbfull.aspx.cs" Inherits="vansystem.Range.Herbfull" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3 id="stickyHeader"><b>Plot Enumeration-Herb</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="Herb" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Herb_Command" Text="Herb"> </asp:LinkButton>
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="DeadWood" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="DeadWood_Command" Text="Dead Wood"> </asp:LinkButton>
                         ...
                         <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="NonClump" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="NonClump_Command" Text="Non Clump"> </asp:LinkButton>
                           <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="LinkButton1" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Stump_Command" Text="Stump"> </asp:LinkButton>
                         <asp:LinkButton runat="server" class="btn btn-xs btn-success" ID="LinkButton2" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="NonClump_Command" Text="Non Clump"> </asp:LinkButton>
                    </div>
                ...
                <div class="card-body" <%--style="height: 100vh!important; overflow-y: auto; margin-left: 2.3%; width: 98.2%;"--%>>
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>

                            <div class="box-content">

                                <asp:GridView ID="GVHerb" runat="server" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" DataKeyNames="id,PlotEnumerationId" OnRowEditing="GVHerb_RowEditing" OnRowUpdating="GVHerb_RowUpdating" OnPageIndexChanging="GVHerb_PageIndexChanging" OnRowCancelingEdit="GVHerb_RowCancelingEdit" OnRowDataBound="GVHerb_RowDataBound" Style="width: 100%" AllowPaging="true" PageSize="10" OnRowCommand="GVHerb_RowCommand">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Specify other" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtothername" runat="server" Text='<%# Eval("othername") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>

                                            </EditItemTemplate>
                                        </asp:TemplateField>


                                        <asp:TemplateField HeaderText="Average number" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblaverageherbs" runat="server" Text='<%# Eval("averageherbs") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtaverageherbs" runat="server" Text='<%# Eval("averageherbs") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Height (in cm)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            ...
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtheight" runat="server" Text='<%# Eval("height") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Approx. weight of NTFP in grams" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                 <asp:Label ID="lblapprox" runat="server" Text='<%# FormatKeyValuePairs(Eval("approx").ToString()) %>'></asp:Label>
                                            </ItemTemplate>
                                           <%-- <EditItemTemplate>
                                                <asp:TextBox ID="txtapprox" runat="server" Text='<%# Eval("approx") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                        ...
                        <Triggers>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="GVHerb" EventName="RowEditing" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
