<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="StaticStump_RFO.aspx.cs" Inherits="vansystem.Range.StaticStump_RFO" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3><b>Plot Enumeration-Stump(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                       ...
                       <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="Stump" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Stump_Command" Text="Stump"> </asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content" style="margin-top:1%">
                                <asp:GridView ID="GVStump" runat="server" AutoGenerateColumns="false" OnRowEditing="GVStump_RowEditing" OnRowUpdating="GVStump_RowUpdating" OnPageIndexChanging="GVStump_PageIndexChanging" OnRowCancelingEdit="GVStump_RowCancelingEdit" OnRowDataBound="GVStump_RowDataBound" ShowHeaderWhenEmpty="true" Style="width: 100%" DataKeyNames="id" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Stump Number">
                                            <ItemTemplate>
                                                <asp:Label ID="lblStumpNo" runat="server" Text='<%# Eval("stumpNumber")%>'></asp:Label>
                                            </ItemTemplate>
                                           <EditItemTemplate>
                                                <asp:TextBox ID="txtStumpNo" runat="server" Text='<%# Eval("stumpNumber") %>' Width="140"  onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Stump Data Direction" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblStumpData" runat="server" Text='<%# Eval("stumpDataDirection") %>'></asp:Label>
                                            </ItemTemplate>
                                            <%--<EditItemTemplate>
                                                <asp:TextBox ID="txtStumpData" runat="server" Text='<%# Eval("stumpDataDirection") %>' Width="140"  onkeydown="return Search_Gridview(event)"></asp:TextBox>

                                            </EditItemTemplate>--%>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Status of Stump" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblStatusStump" runat="server" Text='<%# Eval("statusOfStump")%>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:DropDownList ID="ddlStatusStump" runat="server">
                                                </asp:DropDownList>
                                            </EditItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="Stump Diameter" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblStumpDia" runat="server" Text='<%# Eval("stumpDiameter") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtStumpDia" runat="server" Text='<%# Eval("stumpDiameter") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Stump Height" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblStumpHeight" runat="server" Text='<%# Eval("stumpHeight") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtStumpHeight" runat="server" Text='<%# Eval("stumpHeight") %>' Width="140" onkeydown="return Search_Gridview(event)"></asp:TextBox>
