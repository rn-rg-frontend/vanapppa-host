<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Grassfull.aspx.cs" Inherits="vansystem.Range.Grassfull" %>
...
}@media screen and (min-width: 1900px) and (max-height: 890px){
    .card-body {
        max-height:59rem;
    }
}@media screen and (min-width: 1900px) and (max-height: 869px){
    .card-body {
        max-height:57rem;
    }
}@media screen and (min-width: 1900px) and (max-height: 850px){
    .card-body {
        max-height:54rem;
    }
}@media screen and (min-width: 1900px) and (max-height: 820px){
    .card-body {
        max-height:51rem;
    }
}@media screen and (min-width: 1900px) and (max-height: 789px){
    .card-body {
        max-height:48rem;
    }
}@media screen and (min-width: 1900px) and (max-height: 757px){
    .card-body {
        max-height:44rem;
    }
}@media screen and (min-width: 1806px) and (max-height: 883px){
    .card-body {
        max-height:59rem;
    }
}@media screen and (min-width: 1806px) and (max-height: 864px){
    .card-body {
        max-height:55rem;
    }
}@media screen and (min-width: 1806px) and (max-height: 830px){
    .card-body {
        max-height:52rem;
    }
}@media screen and (min-width: 1806px) and (max-height: 795px){
    .card-body {
        max-height:49rem;
    }
}@media screen and (min-width: 1806px) and (max-height: 768px){
    .card-body {
        max-height:46rem;
    }
}
@media screen and (min-width: 1806px) and (max-height: 740px){
    .card-body {
        max-height:41rem;
    }
}@media screen and (min-width: 1806px) and (max-height: 686px){
    .card-body {
        max-height:38rem;
    }
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3 id="stickyHeader"><b>Plot Enumeration-Grass</b></h3>
                    </div>
                    <div style="margin-top: 20px;">
                        ...
                        <asp:LinkButton runat="server" class="btn btn-xs btn-success active" ID="Grass" CommandArgument='<%# Eval("PlotEnumerationId") %>' OnCommand="Grass_Command" Text="Grass"> </asp:LinkButton>
                ...
                <div class="d-flex justify-content-center align-items-center" style="margin-left: 60%; margin-top: 1%; padding-right:35px; margin-bottom:10px;" >
                    Show
                    <div class="pl-2 pr-2">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVGrass" runat="server" DataKeyNames="id,PlotEnumerationId" ShowHeaderWhenEmpty="true" OnRowEditing="GVGrass_RowEditing" OnRowUpdating="GVGrass_RowUpdating" OnRowCancelingEdit="GVGrass_RowCancelingEdit" OnRowDataBound="GVGrass_RowDataBound" OnPageIndexChanging="GVGrass_PageIndexChanging" AutoGenerateColumns="false" Style="width: 100%" AllowPaging="true" PageSize="10">
