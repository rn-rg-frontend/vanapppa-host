<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="PlotApproach.aspx.cs" Inherits="vansystem.Range.PlotApproach" %>
    ...
    <div>
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; margin-top: 88px;">
                <div class="d-md-flex justify-content-between align-items-center text-center pb-5">
                    ...
                    <asp:UpdatePanel runat="server" ID="updatepanel1">
                        <ContentTemplate>
                            ...
                            <div class="box-content">
                                ...
                                <asp:GridView ID="GVPlotApproach" AutoGenerateColumns="False" runat="server" DataKeyNames="PlotApproachId, uniqueid" OnPageIndexChanging="GVPlotApproach_PageIndexChanging" AllowPaging="true" PageSize="10" OnRowDataBound="GVPlotApproach_RowDataBound" OnRowCancelingEdit="GVPlotApproach_RowCancelingEdit" OnRowCommand="GVPlotApproach_RowCommand" OnRowUpdating="GVPlotApproach_RowUpdating" OnRowEditing="GVPlotApproach_RowEditing" ShowHeaderWhenEmpty="true">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Mammals Comments">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtMammals_comments" runat="server" Text='<%# Bind("Mammals_comments") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
