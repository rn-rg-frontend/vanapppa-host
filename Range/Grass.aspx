<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Grass.aspx.cs" Inherits="vansystem.Range.Grass" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <div>
                            <h3><b style="position: sticky">Plot Enumeration-Grass(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                        </div>
                    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVGrass" runat="server" DataKeyNames="id" ShowHeaderWhenEmpty="true" OnRowEditing="GVGrass_RowEditing" OnRowUpdating="GVGrass_RowUpdating" OnRowCancelingEdit="GVGrass_RowCancelingEdit" OnRowDataBound="GVGrass_RowDataBound" OnPageIndexChanging="GVGrass_PageIndexChanging" AutoGenerateColumns="false" Style="width: 100%;" AllowPaging="true" PageSize="10">
