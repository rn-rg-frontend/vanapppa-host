<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Soil.aspx.cs" Inherits="vansystem.Range.Soil" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3><b>Plot Enumeration-Soil(<asp:Label ID="lblSessionID" runat="server" Text=""></asp:Label>)</b></h3>
                    </div>
                                ...
                                <asp:GridView ID="GVSoil" runat="server" AutoGenerateColumns="false" DataKeyNames="id" Style="width: 100%" OnRowEditing="GVSoil_RowEditing" OnRowUpdating="GVSoil_RowUpdating" OnPageIndexChanging="GVSoil_PageIndexChanging" OnRowDataBound="GVSoil_RowDataBound" OnRowCancelingEdit="GVSoil_RowCancelingEdit" ShowHeaderWhenEmpty="true" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Sample Number">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txSampleNumber" runat="server" Text='<%# Eval("sample_number") %>' onkeydown="return Search_Gridview(event)"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
