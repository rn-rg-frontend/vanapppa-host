<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Leaflitter_full.aspx.cs" Inherits="vansystem.Range.Leaflitter_full" %>
        ...
        <div class="container-fluid mt-6">
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="plot-tree d-md-flex justify-content-between align-content-between text-center">
                    <div>
                        <h3 id="stickyHeader"><b>Plot Enumeration-Leaf  Litter</b></h3>
                    </div>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <div class="box-content">
                                <asp:GridView ID="GVLeaflitter" runat="server" AutoGenerateColumns="false" DataKeyNames="id" OnRowEditing="GVLeaflitter_RowEditing" OnRowUpdating="GVLeaflitter_RowUpdating" OnRowCancelingEdit="GVLeaflitter_RowCancelingEdit" OnPageIndexChanging="GVLeaflitter_PageIndexChanging" OnRowDataBound="GVLeaflitter_RowDataBound" ShowHeaderWhenEmpty="true" Style="width: 100%" AllowPaging="true" PageSize="10">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Leaf litter weight (in Grams)" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblleaf_litter_weight_in_grams" runat="server" Text='<%# Eval("leaf_litter_weight_in_grams") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtleaf_litter_weight_in_grams" runat="server" Text='<%# Eval("leaf_litter_weight_in_grams") %>' Width="140" onkeydown="return Search_Gridview(event)" oninput="DecimalCheck(this);"></asp:TextBox>
                                        ...
                                        <asp:TemplateField HeaderText="Sample Number" ItemStyle-Width="20%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblsample_number" runat="server" Text='<%# Eval("sample_number") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtsample_number" runat="server" Text='<%# Eval("sample_number") %>' onkeydown="return Search_Gridview(event)" Width="140"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
