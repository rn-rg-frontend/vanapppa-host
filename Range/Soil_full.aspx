<%@ Page Title="" Language="C#" MasterPageFile="~/Range/Range.Master" AutoEventWireup="true" CodeBehind="Soil_full.aspx.cs" Inherits="vansystem.Range.Soil_full" %>
                ...
                <div class="card-body" style="background-color: rgb(252, 252, 252); margin-left: 27px; margin-top: 1%;">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                        ...
                        <Triggers>
                            ...
                            <asp:AsyncPostBackTrigger ControlID="GVSoil" EventName="RowEditing" />
                        </Triggers>
                    </asp:UpdatePanel>
                </div>
