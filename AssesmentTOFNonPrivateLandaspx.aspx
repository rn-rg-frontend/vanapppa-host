<%@ Page Title="" Language="C#" MasterPageFile="~/VanUser.Master" AutoEventWireup="true" CodeBehind="AssesmentTOFNonPrivateLandaspx.aspx.cs" Inherits="vansystem.AssesmentTOFNonPrivateLandaspx" %>
            ...
            <div style="margin-left: 0%; /*width: 113%; */ margin-top: 88px;">
                ...
                <div class="card-body" id="cardBody" style="height: 100vh!important; overflow-y: auto; margin-left: 3.5rem !important; width: 98%;">
                    <div class="box-content">
                        ...
                        <asp:GridView ID="gvTOF" AutoGenerateColumns="False" runat="server" DataKeyNames="id" AllowPaging="True" ShowHeaderWhenEmpty="True" Style="width: auto; margin-top: -1%" OnRowCommand="gvTOF_RowCommand" OnRowDataBound="gvTOF_RowDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundField ItemStyle-Width="150px" DataField="Division" HeaderText="Forest  Division" ReadOnly="True">
                                    <ItemStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField ItemStyle-Width="150px" DataField="Range" HeaderText="Forest Range" ReadOnly="True">
                                    <ItemStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField ItemStyle-Width="150px" DataField="Block" HeaderText="Forest Block" ReadOnly="True">
                                    <ItemStyle Width="150px" />
                                </asp:BoundField>
                                <asp:BoundField ItemStyle-Width="150px" DataField="name_of_village" HeaderText="Village">
                                    <ItemStyle Width="150px" />
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Buffer Stratum">
                                    <ItemTemplate>
                                        <asp:Label ID="lblBufferStratum" runat="server" Text='<%# TrimTo(Eval("Buffer_Stratum"),30) %>' />
                                    </ItemTemplate>
                                    <ItemStyle Width="150px" />
                                </asp:TemplateField>
